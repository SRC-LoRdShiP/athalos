...
--   This Is The Source Channel @Tl_300 .     --
--                - athalos -                 --
--        -- https://t.me/Tl_300 --           --
------------------------------------------------ 
...
if not DevSOFI:get(Server.."Idathalos") then 
io.write('\27[1;35m\nالان ارسل ايدي المطور الاساسي ↫ ⤈\n\27[0;33;49m') 
local DraGoN = io.read():gsub(' ','') 
if tostring(DraGoN):match('%d+') then 
...
if not DevSOFI:get(Server.."Tokenathalos") then 
...
Config = {
DraGoN = DevSOFI:get(Server.."Idathalos"),
TokenBot = DevSOFI:get(Server.."Tokenathalos"),
athalos = DevSOFI:get(Server.."Tokenathalos"):match("(%d+)"),
SudoIds = {DevSOFI:get(Server.."Idathalos")},
}
Create(Config, "./config.lua") 
file = io.open("athalos.sh", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/athalos
token="]]..DevSOFI:get(Server.."Tokenathalos")..[["
while(true) do
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"
...
while(true) do
rm -fr ../.telegram-cli
screen -S athalos -X kill
screen -S athalos ./athalos.sh
done
]]) 
file:close() 
...
local Load_athalos = function() 
local f = io.open("./config.lua", "r") 
if not f then 
AutoSet() 
else 
f:close() 
DevSOFI:del(Server.."Idathalos");DevSOFI:del(Server.."Tokenathalos")
end 
...
if msg.sender_user_id_ == tonumber(DraGoN) then 
var = true 
end 
return var 
end
...
if user_id == tonumber(DraGoN) then 
var = true 
end 
return var 
end
...
local Status = DevSOFI:sismember(athalos..'SOFI:SOFISudo:',msg.sender_user_id_) 
...
local Status = DevSOFI:sismember(athalos..'SOFI:SecondSudo:',msg.sender_user_id_) 
...
function Bot(msg) 
local var = false  
if msg.sender_user_id_ == tonumber(athalos) then  
var = true  
end  
return var  
end 
...
local Status = DevSOFI:sismember(athalos..'SOFI:SudoBot:',msg.sender_user_id_) 
...
local Status = DevSOFI:sismember(athalos..'SOFI:SOFIConstructor:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SOFISudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
----   Owner   ----
function Owner(msg) 
local Status = DevSOFI:sismember(athalos..'SOFI:Owner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevSOFI:sismember(athalos..'SOFI:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevSOFI:sismember(athalos..'SOFI:Constructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevSOFI:sismember(athalos..'SOFI:Managers:'..msg.chat_id_,msg.sender_user_id_) 
...
----------  Admin  ---------
function Admin(msg) 
local Status = DevSOFI:sismember(athalos..'SOFI:Admins:'..msg.chat_id_,msg.sender_user_id_) 
...
---------Vip Member---------
function VipMem(msg) 
local Status = DevSOFI:sismember(athalos..'SOFI:VipMem:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevSOFI:sismember(athalos..'SOFI:Cleaner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevSOFI:sismember(athalos..'SOFI:CleanerNum:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevSOFI:sismember(athalos..'SOFI:CleanerMusic:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Cleaner(msg) or SOFIConstructor(msg) or SOFISudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
if DevSOFI:sismember(athalos..'SOFI:Ban:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevSOFI:sismember(athalos..'SOFI:BanAll:', user_id) then
var = true
else
var = false
end
...
if DevSOFI:sismember(athalos..'SOFI:Muted:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevSOFI:sismember(athalos..'SOFI:MuteAll:', user_id) then
var = true
else
var = false
end
...
--     Source athalos     --
function athalosFiles(msg)
for v in io.popen('ls Files'):lines() do
if v:match(".lua$") then
plugin = dofile("Files/"..v)
if plugin.athalos and msg then
FilesText = plugin.athalos(msg)
end
end
end
...
if File_Name ~= "athalos.lua" then 
send(chat,msg.id_," ✧ : هذا الملف ليس تابع لسورس اثالوس")
return false 
end      
...
if File_Name:lower():match('(%d+)') ~= athalos:lower() then 
...
local info_file = io.open('./'..athalos..'.json', "r"):read('*a')
local JsonInfo = JSON.decode(info_file)
vardump(JsonInfo)
DevSOFI:set(athalos.."SOFI:NameBot",JsonInfo.BotName) 
for IdGps,v in pairs(JsonInfo.GroupsList) do
DevSOFI:sadd(athalos.."SOFI:Groups",IdGps) 
DevSOFI:set(athalos.."SOFI:Lock:Bots"..IdGps,"del") DevSOFI:hset(athalos.."SOFI:Spam:Group:User"..IdGps ,"Spam:User","keed") 
...
DevSOFI:set(athalos..Lock..IdGps,true)
end
if v.SOFIConstructors then
for k,IdSOFIConstructors in pairs(v.SOFIConstructors) do
DevSOFI:sadd(athalos..'SOFI:SOFIConstructor:'..IdGps,IdSOFIConstructors)  
print('تم رفع منشئين المجموعات')
end
end
if v.BasicConstructors then
for k,IdBasicConstructors in pairs(v.BasicConstructors) do
DevSOFI:sadd(athalos..'SOFI:BasicConstructor:'..IdGps,IdBasicConstructors)  
print('تم رفع ( '..k..' ) منشئين اساسيين')
end
end
if v.Constructors then
for k,IdConstructors in pairs(v.Constructors) do
DevSOFI:sadd(athalos..'SOFI:Constructor:'..IdGps,IdConstructors)  
print('تم رفع ( '..k..' ) منشئين')
end
end
if v.Managers then
for k,IdManagers in pairs(v.Managers) do
DevSOFI:sadd(athalos..'SOFI:Managers:'..IdGps,IdManagers)  
...
vardump(IdAdmins)
DevSOFI:sadd(athalos..'SOFI:Admins:'..IdGps,IdAdmins)  
print('تم رفع ( '..k..' ) ادمنيه')
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
DevSOFI:sadd(athalos..'SOFI:VipMem:'..IdGps,IdVips)  
print('تم رفع ( '..k..' ) مميزين')
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
DevSOFI:set(athalos.."SOFI:Groups:Links"..IdGps,v.LinkGroups)   
print('( تم وضع روابط المجموعات )')
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
DevSOFI:set(athalos.."SOFI:Groups:Welcomes"..IdGps,v.Welcomes)   
...
var = true
elseif DevSOFI:sismember(athalos..'SOFI:SOFISudo:', user_id) then
var = true
elseif DevSOFI:sismember(athalos..'SOFI:SecondSudo:', user_id) then
var = true  
elseif DevSOFI:sismember(athalos..'SOFI:SudoBot:', user_id) then
var = true 
elseif DevSOFI:sismember(athalos..'SOFI:SOFIConstructor:'..chat_id, user_id) then
var = true
elseif DevSOFI:sismember(athalos..'SOFI:Owner:'..chat_id, user_id) then
var = true
elseif DevSOFI:sismember(athalos..'SOFI:BasicConstructor:'..chat_id, user_id) then
var = true
elseif DevSOFI:sismember(athalos..'SOFI:Constructor:'..chat_id, user_id) then
var = true  
elseif DevSOFI:sismember(athalos..'SOFI:Managers:'..chat_id, user_id) then
var = true  
elseif DevSOFI:sismember(athalos..'SOFI:Admins:'..chat_id, user_id) then
var = true  
elseif DevSOFI:sismember(athalos..'SOFI:VipMem:'..chat_id, user_id) then  
var = true 
else  
var = false
end  
...
local SOFI = (athalos..'SOFI:Filters:'..msg.chat_id_)
if SOFI then
...
local UserName = (dp.username_ or "Tl_300")
...
--     Source athalos     --
function SOFImoned(chat_id, user_id, msg_id, text, offset, length) local tt = DevSOFI:get(athalos..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
--     Source athalos     --
function ChCheck(msg)
local var = true 
if DevSOFI:get(athalos.."SOFI:ChId") then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getchatmember?chat_id='..DevSOFI:get(athalos..'SOFI:ChId')..'&user_id='..msg.sender_user_id_)
local data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
var = false 
if DevSOFI:get(athalos..'SOFI:ChText') then
...
if DataText == '/delyes' and DevSOFI:get(athalos..'yes'..data.sender_user_id_) == 'delyes' then
DevSOFI:del(athalos..'yes'..data.sender_user_id_, 'delyes')
DevSOFI:del(athalos..'no'..data.sender_user_id_, 'delno')
...
if DataText == '/delno' and DevSOFI:get(athalos..'no'..data.sender_user_id_) == 'delno' then
DevSOFI:del(athalos..'yes'..data.sender_user_id_, 'delyes')
DevSOFI:del(athalos..'no'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "✧ : تم الغاء امر اطردني") 
end
--     Source athalos     --
if DataText == '/yesdel' and DevSOFI:get(athalos..'yesdel'..data.sender_user_id_) == 'delyes' then
DevSOFI:del(athalos..'yesdel'..data.sender_user_id_, 'delyes')
DevSOFI:del(athalos..'nodel'..data.sender_user_id_, 'delno')
if DevSOFI:sismember(athalos..'SOFI:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevSOFI:sismember(athalos..'SOFI:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if DevSOFI:sismember(athalos..'SOFI:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevSOFI:sismember(athalos..'SOFI:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevSOFI:sismember(athalos..'SOFI:Cleaner:'..data.chat_id_, data.sender_user_id_) then
cleaner = 'المنظفين • ' else cleaner = '' end
if DevSOFI:sismember(athalos..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
donky = 'المطايه • ' else donky = '' end
if DevSOFI:sismember(athalos..'SOFI:Constructor:'..data.chat_id_, data.sender_user_id_) or DevSOFI:sismember(athalos..'SOFI:Managers:'..data.chat_id_, data.sender_user_id_) or DevSOFI:sismember(athalos..'SOFI:Admins:'..data.chat_id_, data.sender_user_id_) or DevSOFI:sismember(athalos..'SOFI:VipMem:'..data.chat_id_, data.sender_user_id_) or DevSOFI:sismember(athalos..'SOFI:Cleaner:'..data.chat_id_, data.sender_user_id_) or DevSOFI:sismember(athalos..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
DevSOFI:srem(athalos..'SOFI:Constructor:'..data.chat_id_,data.sender_user_id_)
DevSOFI:srem(athalos..'SOFI:Managers:'..data.chat_id_,data.sender_user_id_)
DevSOFI:srem(athalos..'SOFI:Admins:'..data.chat_id_,data.sender_user_id_)
DevSOFI:srem(athalos..'SOFI:VipMem:'..data.chat_id_,data.sender_user_id_)
DevSOFI:srem(athalos..'SOFI:Cleaner:'..data.chat_id_,data.sender_user_id_)
DevSOFI:srem(athalos..'User:Donky:'..data.chat_id_,data.sender_user_id_)
...
if DevSOFI:get(athalos.."SOFI:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "✧ : تم الغاء امر تغير المطور الاساسي") 
DevSOFI:del(athalos.."SOFI:NewDev"..data.sender_user_id_)
return false
end
if DataText == '/setyes' then
local NewDev = DevSOFI:get(athalos.."SOFI:NewDev"..data.sender_user_id_)
...
if DataText == '/nodel' and DevSOFI:get(athalos..'nodel'..data.sender_user_id_) == 'delno' then
DevSOFI:del(athalos..'yesdel'..data.sender_user_id_, 'delyes')
DevSOFI:del(athalos..'nodel'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "✧ : تم الغاء امر نزلني") 
end
if DataText == '/YesRolet' and DevSOFI:get(athalos.."SOFI:WittingStartRolet"..data.chat_id_..data.sender_user_id_) then
local List = DevSOFI:smembers(athalos..'SOFI:ListRolet'..data.chat_id_) 
local UserName = List[math.random(#List)]
tdcli_function ({ID="SearchPublicChat",username_ = UserName},function(arg,dp) 
DevSOFI:incrby(athalos..'SOFI:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
DevSOFI:del(athalos..'SOFI:ListRolet'..data.chat_id_) 
DevSOFI:del(athalos.."SOFI:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "✧ : *صاحب الحظ* ↫ ["..UserName.."]\n✧ : *مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
DevSOFI:del(athalos..'SOFI:ListRolet'..data.chat_id_) 
DevSOFI:del(athalos.."SOFI:NumRolet"..data.chat_id_..data.sender_user_id_) 
DevSOFI:del(athalos.."SOFI:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
...
if DevSOFI:sismember(athalos..'SOFI:Tkeed:'..Chat_Id2, data.sender_user_id_) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..Chat_Id2.."&user_id="..data.sender_user_id_.."&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
DevSOFI:srem(athalos..'SOFI:Tkeed:'..Chat_Id2, data.sender_user_id_)
...
DevSOFI:del(athalos..'SOFI:Text:GpTexts'..SOFI..data.chat_id_)
DevSOFI:srem(athalos..'SOFI:Manager:GpRedod'..data.chat_id_,SOFI)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local SOFI = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevSOFI:smembers(athalos..'SOFI:Text:GpTexts'..SOFI..data.chat_id_)
if DevSOFI:get(athalos..'SOFI:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "✧ : تم انهاء وحفظ ↫ "..#List.." من الردود المتعدده للامر ↫ "..SOFI) 
DevSOFI:del(athalos..'SOFI:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
DevSOFI:del(athalos..'SOFI:Text:GpTexts'..SOFI..data.chat_id_)
DevSOFI:del(athalos..'SOFI:Add:GpTexts'..data.sender_user_id_..data.chat_id_)
DevSOFI:srem(athalos..'SOFI:Manager:GpRedod'..data.chat_id_,SOFI)
else
EditMsg(Chat_Id2, Msg_Id2, "✧ : عذرا صلاحية الامر منتهيه !") 
end
...
if text and DevSOFI:get(athalos.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = DevSOFI:get(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
DevSOFI:del(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
DevSOFI:del(athalos.."Set:Cmd:Group:New"..msg.chat_id_)
DevSOFI:srem(athalos.."List:Cmd:Group:New"..msg.chat_id_,text)
...
DevSOFI:del(athalos.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if text and text:match('^'..(DevSOFI:get(athalos..'SOFI:NameBot') or "اثالوس")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevSOFI:get(athalos..'SOFI:NameBot') or "اثالوس")..' ','')
end
if data.message_.content_.text_ then
local NewCmmd = DevSOFI:get(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
if text and DevSOFI:get(athalos.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
DevSOFI:set(athalos.."Set:Cmd:Group:New"..msg.chat_id_,text)
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : ارسل الامر الجديد", 1, 'html')
DevSOFI:del(athalos.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
DevSOFI:set(athalos.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and DevSOFI:get(athalos.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = DevSOFI:get(athalos.."Set:Cmd:Group:New"..msg.chat_id_)
DevSOFI:set(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
DevSOFI:sadd(athalos.."List:Cmd:Group:New"..msg.chat_id_,text)
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم حفظ الامر", 1, 'html')
DevSOFI:del(athalos.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
...
local List = DevSOFI:smembers(athalos.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(List) do
DevSOFI:del(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
DevSOFI:del(athalos.."List:Cmd:Group:New"..msg.chat_id_)
end
...
DevSOFI:set(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
DevSOFI:sadd(athalos.."List:Cmd:Group:New"..msg.chat_id_,"ا")
DevSOFI:set(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
DevSOFI:sadd(athalos.."List:Cmd:Group:New"..msg.chat_id_,"م")
DevSOFI:set(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
DevSOFI:sadd(athalos.."List:Cmd:Group:New"..msg.chat_id_,"اد")
DevSOFI:set(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
DevSOFI:sadd(athalos.."List:Cmd:Group:New"..msg.chat_id_,"مد")
DevSOFI:set(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
DevSOFI:sadd(athalos.."List:Cmd:Group:New"..msg.chat_id_,"من")
DevSOFI:set(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
DevSOFI:sadd(athalos.."List:Cmd:Group:New"..msg.chat_id_,"اس")
DevSOFI:set(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":مط","رفع مطور")
DevSOFI:sadd(athalos.."List:Cmd:Group:New"..msg.chat_id_,"مط")
DevSOFI:set(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":ثانوي","رفع مطور ثانوي")
DevSOFI:sadd(athalos.."List:Cmd:Group:New"..msg.chat_id_,"ثانوي")
DevSOFI:set(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
DevSOFI:sadd(athalos.."List:Cmd:Group:New"..msg.chat_id_,"تك")
DevSOFI:set(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevSOFI:sadd(athalos.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
DevSOFI:set(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevSOFI:sadd(athalos.."List:Cmd:Group:New"..msg.chat_id_,"تفع")
DevSOFI:set(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":ر","الرابط")
DevSOFI:sadd(athalos.."List:Cmd:Group:New"..msg.chat_id_,"ر")
DevSOFI:set(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":رر","ردود المدير")
DevSOFI:sadd(athalos.."List:Cmd:Group:New"..msg.chat_id_,"رر")
DevSOFI:set(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":،،","مسح المكتومين")
DevSOFI:sadd(athalos.."List:Cmd:Group:New"..msg.chat_id_,"،،")
DevSOFI:set(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
DevSOFI:sadd(athalos.."List:Cmd:Group:New"..msg.chat_id_,"رد")
DevSOFI:set(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":سح","مسح سحكاتي")
DevSOFI:sadd(athalos.."List:Cmd:Group:New"..msg.chat_id_,"سح")
DevSOFI:set(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":رس","مسح رسائلي")
DevSOFI:sadd(athalos.."List:Cmd:Group:New"..msg.chat_id_,"رس")
DevSOFI:set(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":غ","غنيلي")
DevSOFI:sadd(athalos.."List:Cmd:Group:New"..msg.chat_id_,"غ")
DevSOFI:set(athalos.."Set:Cmd:Group:New1"..msg.chat_id_..":#","مسح قائمه العام")
DevSOFI:sadd(athalos.."List:Cmd:Group:New"..msg.chat_id_,"#")
...
DevSOFI:set(athalos.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
DevSOFI:set(athalos.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local List = DevSOFI:smembers(athalos.."Coomds"..msg.chat_id_)
if #List == 0 then
...
local List = DevSOFI:smembers(athalos.."Coomds"..msg.chat_id_)
for k,v in pairs(List) do
DevSOFI:del(athalos.."Comd:New:rt:SOFI:"..v..msg.chat_id_)
DevSOFI:del(athalos.."Coomds"..msg.chat_id_)
end
...
DevSOFI:set(athalos.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
DevSOFI:sadd(athalos.."Coomds"..msg.chat_id_,ComdNew)  
DevSOFI:setex(athalos.."Comd:New"..msg.chat_id_..msg.sender_user_id_,200,true)  
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : ارسل نوع الصلاحيه \n{ عضو • مميز  • ادمن  • مدير }\n✧ : ارسل الغاء لالغاء الامر ", 1, 'html')
end
if text and text:match("^حذف صلاحيه (.*)$") and ChCheck(msg) or text and text:match("^مسح صلاحيه (.*)$") and ChCheck(msg) then 
ComdNew = text:match("^حذف صلاحيه (.*)$") or text:match("^مسح صلاحيه (.*)$")
DevSOFI:del(athalos.."Comd:New:rt:SOFI:"..ComdNew..msg.chat_id_)
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم حذف الصلاحيه", 1, 'html')
end
if DevSOFI:get(athalos.."Comd:New"..msg.chat_id_..msg.sender_user_id_) then 
if text and text:match("^↫ الغاء ✧$") then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم الغاء الامر", 1, 'html')
DevSOFI:del(athalos.."Comd:New"..msg.chat_id_..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = DevSOFI:get(athalos.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
DevSOFI:set(athalos.."Comd:New:rt:SOFI:"..textn..msg.chat_id_,text)
...
if DevSOFI:sismember(athalos.."Coomds"..msg.chat_id_,DEV_SOFI) then
...
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'Tl_300')..')'..' ❩\n✧ : تم رفعه ❨ '..DEV_SOFI..' ❩ بنجاح', 1, 'md')
...
if DevSOFI:sismember(athalos.."Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local mrSOFI = DevSOFI:get(athalos.."Comd:New:rt:SOFI:"..text1[2]..msg.chat_id_)
if mrSOFI == "مميز" and VipMem(msg) then
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'Tl_300')..')'..' ❩\n✧ : تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
DevSOFI:incr(athalos..'SOFI:UsersMsgs'..athalos..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
DevSOFI:incr(athalos..'SOFI:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
DevSOFI:incr(athalos..'SOFI:MsgNumberDay'..msg.chat_id_..':'..os.date('%d'))  
ChatType = 'sp' 
elseif id:match("^(%d+)") then
if not DevSOFI:sismember(athalos.."SOFI:Users",msg.chat_id_) then
DevSOFI:sadd(athalos.."SOFI:Users",msg.chat_id_)
end
ChatType = 'pv' 
else
ChatType = 'gp' 
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✧ : اهلا بك مجددا عزيزي المطور \n✧ : اليك الازرار الخاصه بتعديل وتغيير كلايش سورس اثالوس فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'تغير معلومات الترحيب'},
...
if text == '↫ السورس ✧' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '✧ : اهلا بك مجددا عزيزي المطور \n✧ : اليك الازرار الخاصه بتحديث  سورس اثالوس فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ تحديث السورس ✧','↫ تحديث ✧'},
{'↫ السيرفر ✧'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✧ : اهلا بك مجددا عزيزي المطور \n✧ : اليك الازرار الخاصه ب أحصائيات  سورس اثالوس فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫  الاحصائيات ✧'},
{'↫ المشتركين ✧','↫ المجموعات ✧'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✧ : اهلا بك مجددا عزيزي المطور \n✧ : اليك الازرار الخاصه ب المطورين لسورس اثالوس فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✧ : اهلا بك مجددا عزيزي المطور \n✧ : اليك الازرار الخاصه ب التفعيل والتعطيل لسورس اثالوس فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✧ : اهلا بك مجددا عزيزي المطور \n✧ : اليك الازرار الخاصه بالاذاعه لسورس اثالوس فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ اذاعه بالتثبيت ✧'},
{'↫ اذاعه خاص ✧','↫ اذاعه عام ✧'},
...
if text == '↫ العام ✧' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '✧ : اهلا بك مجددا عزيزي المطور \n✧ : اليك الازرار الخاصه بالعام لسورس اثالوس فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✧ : اهلا بك مجددا عزيزي المطور \n✧ : اليك الازرار الخاصه بردود الخاص لسورس اثالوس فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✧ : اهلا بك مجددا عزيزي المطور \n✧ : اليك الازرار الخاصه بالاشتراك الاجباري لسورس اثالوس فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '✧ : اهلا بك مجددا عزيزي \n✧ : اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس اثالوس فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ غنيلي ✧','↫ اغنيه ✧'},
{'↫ ميمز ✧','↫ ريمكس ✧'},
{'↫ صوره ✧','↫ متحركه ✧'},
...
local Sudo_Welcome = '✧ : اهلا بك مجددا عزيزي \n✧ : اليك الازرار الخاصه بأوامر النسب الخاصه بسورس اثالوس فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if text == '↫ العاب ✧' then 
local Sudo_Welcome = '✧ : اهلا بك مجددا عزيزي \n✧ : اليك الازرار الخاصه بألعاب سورس اثالوس فقط اضغط على اللعبه الذي تريد لعبها'
local key = {
...
local inline = {
{{text="✧ المطور .",url="t.me/"..(dp.username_ or "Tl_300")}},
{{text="✧ السورس .",url="https://t.me/Tl_300"},{text="✧ لتنصيب بوت .",url="https://t.me/GD_300"}},{{text="✧ اضفني في مجموعتك .",url="t.me/"..dp.username_.."?startgroup=botstart"}}
}
...
DevSOFI:setex(athalos..'SOFI:Start:Time'..msg.sender_user_id_,300,true)
return false
end 
--     Source athalos     --
...
Dev_SOFI(msg.sender_user_id_, msg.id_, 1, '✧ : تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "Tl_300")..')', 1, 'md') 
...
SendText(DraGoN,'✧ : تم ارسال الملصق من ↫ ⤈\n['..string.sub(dp.first_name_,0, 40)..'](tg://user?id='..dp.id_..')',0,'md') 
return false
...
SendText(DraGoN,Text,msg.id_/2097152/0.5,'md') 
DevSOFI:sadd(athalos..'SOFI:Ban:Pv',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then
local Text = '✧ : العضو ↫ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n✧ : تم الغاء حظره من التواصل'
SendText(DraGoN,Text,msg.id_/2097152/0.5,'md') 
DevSOFI:srem(athalos..'SOFI:Ban:Pv',data.id_)  
return false  
end 
...
--     Source athalos     --
if text and DevSOFI:get(athalos..'SOFI:Start:Bots'..msg.sender_user_id_) then
if text == 'الغاء' then   
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء حفظ كليشة الستارت', 1, 'md')
DevSOFI:del(athalos..'SOFI:Start:Bots'..msg.sender_user_id_) 
return false
end
DevSOFI:set(athalos.."SOFI:Start:Bot",text)  
...
DevSOFI:set(athalos..'SOFI:Start:Bots'..msg.sender_user_id_,true) 
...
DevSOFI:del(athalos.."SOFI:Lock:AutoFile")
end
...
DevSOFI:set(athalos.."SOFI:Lock:AutoFile",true) 
end
end
end
--     Source athalos     --
...
local athalosTeam = {'- Nothing stops him who wants you .','make them wish they had you !.','Maybe a magical girl','٫ 𝖡𝖾 𝗌𝗂𝗆𝗉𝗅𝖾 𝖺𝗇𝖽 𝖽𝗂𝖿𝖿𝖾𝗋𝖾𝗇𝗍','. 𝖬𝖺𝗄𝖾 𝖽𝗋𝖾𝖺𝗆𝗌 𝖿𝗋𝗈𝗆 𝗒𝗈𝗎𝗋 𝗋𝖾𝖿𝗋𝖺𝖼𝗍𝗂𝗈𝗇𝗌 . .',':Life is lying .','𝖨 𝗐𝗂𝗅𝗅 𝖺𝗅𝗐𝖺𝗒𝗌 𝗅𝗈𝗏𝖾 𝗒𝗈𝗎 𝗇𝖾𝗏𝖾𝗋 𝖿𝗈𝗋𝗀𝖾𝗍'}  
Dev_SOFI(msg.chat_id_, msg.id_, 1, ''..athalosTeam[math.random(#athalosTeam)]..'' , 1, 'md')  
return false
end
--     Source athalos     --
if text and (text == 'المطور' or text == 'مطور' or text == '↫  المطور ✧') then
tdcli_function({ID="GetUser",user_id_=DraGoN},function(arg,result)
local msg_id = msg.id_/2097152/0.5
Text = "*✧ : Dev Name ↬ * ["..result.first_name_.."](T.me/"..result.username_..")\n*✧ : Dev User ↬* [@"..result.username_.."]"
keyboard = {} 
keyboard.inline_keyboard = {{{text = ''..result.first_name_..' ',url="t.me/"..result.username_ or Tl_300}}}
...
local my_ph = DevSOFI:get(athalos.."SOFI:Photo:Profile"..msg.chat_id_)
if not my_ph then
...
if not DevSOFI:get(athalos..'SOFI:Lock:Gamesinline'..msg.chat_id_) then
Text =[[
...
{{text = '✧ athalos Team .', url="t.me/Tl_300"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
DevSOFI:incr(athalos..'SOFI:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)
DevSOFI:set(athalos.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = DevSOFI:get(athalos.."SOFI:Lock:Bots"..msg.chat_id_) 
for i=0,#mem_id do  
...
DevSOFI:sadd(athalos..'SOFI:Tkeed:'..msg.chat_id_, msg.sender_user_id_)
GetInfo = https.request("https://api.telegram.org/bot"..TokenBot.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local JsonInfo = JSON.decode(GetInfo)
if JsonInfo.ok == true and #mem_id == i then
local Msgs = {}
...
if msg.content_.ID == "MessageChatDeleteMember" and tonumber(msg.content_.user_.id_) == tonumber(athalos) then 
DevSOFI:srem(athalos.."SOFI:Groups", msg.chat_id_) 
...
if DevSOFI:get(athalos..'SOFI:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})    
end   
end
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then   
DevSOFI:incr(athalos..'SOFI:EntryNumber'..msg.chat_id_..':'..os.date('%d'))  
elseif msg.content_.ID == "MessageChatDeleteMember" then   
DevSOFI:incr(athalos..'SOFI:ExitNumber'..msg.chat_id_..':'..os.date('%d'))  
end
--     Source athalos     --
if text ==('تفعيل') and not SudoBot(msg) and ChCheck(msg) then
if not DevSOFI:get(athalos..'SOFI:Lock:FreeBot'..athalos) then
if ChatType == 'pv' then
...
DevSOFI:sadd(athalos..'SOFI:Admins:'..msg.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevSOFI:srem(athalos..'SOFI:Admins:'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
DevSOFI:sadd(athalos..'SOFI:Admins:'..msg.chat_id_, admins[i].user_id_)
...
DevSOFI:sadd(athalos.."SOFI:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevSOFI:sadd(athalos.."SOFI:SOFIConstructor:"..msg.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevSOFI:srem(athalos.."SOFI:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevSOFI:srem(athalos.."SOFI:SOFIConstructor:"..msg.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if DevSOFI:sismember(athalos..'SOFI:Groups',msg.chat_id_) then
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : المجموعه بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(DevSOFI:get(athalos..'SOFI:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : عدد اعضاء المجموعه اقل من ↫ *'..(DevSOFI:get(athalos..'SOFI:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","✧ : تم تفعيل المجموعه "..dp.title_)  
DevSOFI:sadd(athalos.."SOFI:Groups",msg.chat_id_)
DevSOFI:sadd(athalos..'SOFI:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
DevSOFI:set(athalos..'Save:UserName'..msg.sender_user_id_,data.username_)
end;end,nil) 
--     Source athalos     --
local ReFalse = tostring(msg.chat_id_)
if not DevSOFI:sismember(athalos.."SOFI:Groups",msg.chat_id_) and not ReFalse:match("^(%d+)") and not SudoBot(msg) then
...
if DevSOFI:get(athalos..'SOFI:Lock:Robot'..msg.chat_id_) then
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,dp) 
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..dp.id_)
DevSOFI:sadd(athalos..'SOFI:Tkeed:'..msg.chat_id_, dp.id_)
...
if DevSOFI:get(athalos.."SOFI:Lock:Join"..msg.chat_id_) then
...
if not Bot(msg) then 
local filter = DevSOFI:smembers(athalos.."SOFI:FilterPhoto"..msg.chat_id_)
...
if not Bot(msg) then 
local filter = DevSOFI:smembers(athalos.."SOFI:FilterAnimation"..msg.chat_id_)
for k,v in pairs(filter) do
...
if not Bot(msg) then 
local filter = DevSOFI:smembers(athalos.."SOFI:FilterSteckr"..msg.chat_id_)
for k,v in pairs(filter) do
...
local DelGpRedRedods = DevSOFI:get(athalos..'SOFI:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
local GetGpTexts = DevSOFI:get(athalos..'SOFI:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
if DelGpRedRedods == 'DelGpRedRedods' then
Dev_SOFI(msg.chat_id_, msg.id_, 1,'✧ : الرد ↫ '..msg.content_.text_..' للكلمه ↫ '..GetGpTexts..' تم حذفها',  1, "html")
DevSOFI:del(athalos..'SOFI:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevSOFI:srem(athalos..'SOFI:Text:GpTexts'..GetGpTexts..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevSOFI:get(athalos..'SOFI:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRedod' then
Dev_SOFI(msg.chat_id_, msg.id_, 1,'✧ : الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevSOFI:del(athalos..'SOFI:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:Text:GpTexts'..msg.content_.text_..msg.chat_id_)
DevSOFI:srem(athalos..'SOFI:Manager:GpRedod'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevSOFI:get(athalos..'SOFI:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRed' then
Dev_SOFI(msg.chat_id_, msg.id_, 1,'✧ : الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevSOFI:del(athalos..'SOFI:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:Gif:GpRed'..msg.content_.text_..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:Voice:GpRed'..msg.content_.text_..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:Audio:GpRed'..msg.content_.text_..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:Photo:GpRed'..msg.content_.text_..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:Stecker:GpRed'..msg.content_.text_..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:Video:GpRed'..msg.content_.text_..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:File:GpRed'..msg.content_.text_..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:Text:GpRed'..msg.content_.text_..msg.chat_id_)
DevSOFI:srem(athalos..'SOFI:Manager:GpRed'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelAllRed = DevSOFI:get(athalos.."SOFI:Add:AllRed"..msg.sender_user_id_)
if DelAllRed == 'DelAllRed' then
Dev_SOFI(msg.chat_id_, msg.id_, 1,'✧ : الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevSOFI:del(athalos.."SOFI:Add:AllRed"..msg.sender_user_id_)
DevSOFI:del(athalos.."SOFI:Gif:AllRed"..msg.content_.text_)
DevSOFI:del(athalos.."SOFI:Voice:AllRed"..msg.content_.text_)
DevSOFI:del(athalos.."SOFI:Audio:AllRed"..msg.content_.text_)
DevSOFI:del(athalos.."SOFI:Photo:AllRed"..msg.content_.text_)
DevSOFI:del(athalos.."SOFI:Stecker:AllRed"..msg.content_.text_)
DevSOFI:del(athalos.."SOFI:Video:AllRed"..msg.content_.text_)
DevSOFI:del(athalos.."SOFI:File:AllRed"..msg.content_.text_)
DevSOFI:del(athalos.."SOFI:Text:AllRed"..msg.content_.text_)
DevSOFI:del(athalos.."SOFI:Sudo:AllRed",msg.content_.text_)
return false
end
end
--     Source athalos     --
if text and text:match("^(.*)$") then
local SaveGpRedod = DevSOFI:get(athalos..'SOFI:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRedod == 'SaveGpRedod' then
local GetGpTexts = DevSOFI:get(athalos..'SOFI:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevSOFI:smembers(athalos..'SOFI:Text:GpTexts'..GetGpTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : ✧ : تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..GetGpTexts ,  1, "md")
DevSOFI:del(athalos..'SOFI:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:Text:GpTexts'..GetGpTexts..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
DevSOFI:srem(athalos..'SOFI:Manager:GpRedod'..msg.chat_id_,GetGpTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevSOFI:sadd(athalos..'SOFI:Text:GpTexts'..GetGpTexts..msg.chat_id_,Text)
if #List == 4 then 
...
if text and not DevSOFI:get(athalos..'SOFI:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_) then
if DevSOFI:sismember(athalos..'SOFI:Manager:GpRedod'..msg.chat_id_,text) then
local athalosTeam =  DevSOFI:smembers(athalos..'SOFI:Text:GpTexts'..text..msg.chat_id_)
Dev_SOFI(msg.chat_id_, msg.id_, 1, '['..athalosTeam[math.random(#athalosTeam)]..']' , 1, 'md')  
end
end
--     Source athalos     --
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then 
local SaveGpRed = DevSOFI:get(athalos..'SOFI:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRed == 'SaveGpRed' then 
if text == 'الغاء' then
local DelManagerRep = DevSOFI:get(athalos..'DelManagerRep'..msg.chat_id_)
DevSOFI:srem(athalos..'SOFI:Manager:GpRed'..msg.chat_id_,DelManagerRep)
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء حفظ الرد', 1, 'md')
DevSOFI:del(athalos..'SOFI:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevSOFI:del(athalos..'DelManagerRep'..msg.chat_id_)
return false
end
DevSOFI:del(athalos..'SOFI:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
local SaveGpRed = DevSOFI:get(athalos..'SOFI:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
if msg.content_.video_ then DevSOFI:set(athalos..'SOFI:Video:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then DevSOFI:set(athalos..'SOFI:File:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then DevSOFI:set(athalos..'SOFI:Stecker:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_) 
end 
if msg.content_.voice_ then DevSOFI:set(athalos..'SOFI:Voice:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_) 
end
if msg.content_.audio_ then DevSOFI:set(athalos..'SOFI:Audio:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_) 
end
...
DevSOFI:set(athalos..'SOFI:Photo:GpRed'..SaveGpRed..msg.chat_id_, photo_in_group) 
end
if msg.content_.animation_ then DevSOFI:set(athalos..'SOFI:Gif:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_) 
end 
if msg.content_.text_ then
DevSOFI:set(athalos..'SOFI:Text:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.text_)
end 
...
if msg.content_.text_ and not DevSOFI:get(athalos..'SOFI:Lock:GpRed'..msg.chat_id_) then 
if DevSOFI:get(athalos..'SOFI:Video:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevSOFI:get(athalos..'SOFI:Video:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevSOFI:get(athalos..'SOFI:File:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevSOFI:get(athalos..'SOFI:File:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevSOFI:get(athalos..'SOFI:Voice:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevSOFI:get(athalos..'SOFI:Voice:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevSOFI:get(athalos..'SOFI:Audio:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevSOFI:get(athalos..'SOFI:Audio:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevSOFI:get(athalos..'SOFI:Photo:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevSOFI:get(athalos..'SOFI:Photo:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevSOFI:get(athalos..'SOFI:Gif:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevSOFI:get(athalos..'SOFI:Gif:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevSOFI:get(athalos..'SOFI:Stecker:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevSOFI:get(athalos..'SOFI:Stecker:GpRed'..msg.content_.text_..msg.chat_id_))
end
if DevSOFI:get(athalos..'SOFI:Text:GpRed'..msg.content_.text_..msg.chat_id_) then
function athalosTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevSOFI:get(athalos..'SOFI:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevSOFI:get(athalos..'SOFI:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevSOFI:get(athalos..'SOFI:Text:GpRed'..msg.content_.text_..msg.chat_id_)
...
getUser(msg.sender_user_id_, athalosTeam)
end
end
--     Source athalos     --
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local SaveAllRed = DevSOFI:get(athalos.."SOFI:Add:AllRed"..msg.sender_user_id_)
if SaveAllRed == 'SaveAllRed' then
if text == 'الغاء' then
local DelSudoRep = DevSOFI:get(athalos..'DelSudoRep')
DevSOFI:del(athalos.."SOFI:Sudo:AllRed",DelSudoRep)
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء حفظ الرد', 1, 'md')
DevSOFI:del(athalos.."SOFI:Add:AllText"..msg.sender_user_id_)
DevSOFI:del(athalos.."SOFI:Add:AllRed"..msg.sender_user_id_)
DevSOFI:del(athalos.."DelSudoRep")
return false
end
DevSOFI:del(athalos.."SOFI:Add:AllRed"..msg.sender_user_id_)
local SaveAllRed = DevSOFI:get(athalos.."SOFI:Add:AllText"..msg.sender_user_id_)
if msg.content_.video_ then
DevSOFI:set(athalos.."SOFI:Video:AllRed"..SaveAllRed, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
DevSOFI:set(athalos.."SOFI:File:AllRed"..SaveAllRed, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
DevSOFI:set(athalos.."SOFI:Stecker:AllRed"..SaveAllRed, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
DevSOFI:set(athalos.."SOFI:Voice:AllRed"..SaveAllRed, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
DevSOFI:set(athalos.."SOFI:Audio:AllRed"..SaveAllRed, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
DevSOFI:set(athalos.."SOFI:Photo:AllRed"..SaveAllRed, photo_in_all_groups)
end
if msg.content_.animation_ then
DevSOFI:set(athalos.."SOFI:Gif:AllRed"..SaveAllRed, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
DevSOFI:set(athalos.."SOFI:Text:AllRed"..SaveAllRed, msg.content_.text_)
end 
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم حفظ الرد الجديد', 1, 'md') 
DevSOFI:del(athalos.."SOFI:Add:AllText"..msg.sender_user_id_)
DevSOFI:del(athalos..'DelSudoRep')
return false end end
if msg.content_.text_ and not DevSOFI:get(athalos..'SOFI:Lock:AllRed'..msg.chat_id_) then
if DevSOFI:get(athalos.."SOFI:Video:AllRed"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevSOFI:get(athalos.."SOFI:Video:AllRed"..msg.content_.text_))
end
if DevSOFI:get(athalos.."SOFI:File:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevSOFI:get(athalos.."SOFI:File:AllRed"..msg.content_.text_))
end
if DevSOFI:get(athalos.."SOFI:Voice:AllRed"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevSOFI:get(athalos.."SOFI:Voice:AllRed"..msg.content_.text_))
end
if DevSOFI:get(athalos.."SOFI:Audio:AllRed"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevSOFI:get(athalos.."SOFI:Audio:AllRed"..msg.content_.text_))
end
if DevSOFI:get(athalos.."SOFI:Photo:AllRed"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevSOFI:get(athalos.."SOFI:Photo:AllRed"..msg.content_.text_))
end
if  DevSOFI:get(athalos.."SOFI:Gif:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevSOFI:get(athalos.."SOFI:Gif:AllRed"..msg.content_.text_))
end
if DevSOFI:get(athalos.."SOFI:Stecker:AllRed"..msg.content_.text_) then
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevSOFI:get(athalos.."SOFI:Stecker:AllRed"..msg.content_.text_))
end
if DevSOFI:get(athalos.."SOFI:Text:AllRed"..msg.content_.text_) then
function athalosTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevSOFI:get(athalos..'SOFI:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevSOFI:get(athalos..'SOFI:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevSOFI:get(athalos.."SOFI:Text:AllRed"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'لا يوجد')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
...
if Type == "keed" and not DevSOFI:sismember(athalos..'SOFI:Tkeed:'..msg.chat_id_, msg.sender_user_id_) then
...
if Type == "mute" and not DevSOFI:sismember(athalos..'SOFI:Muted:'..msg.chat_id_, msg.sender_user_id_) then
DevSOFI:sadd(athalos..'SOFI:Muted:'..msg.chat_id_,msg.sender_user_id_)
my_ide = msg.sender_user_id_
msgm = msg.id_
local num = 100
for i=1,tonumber(num) do
...
--  end functions athalos --
--     Source athalos     --
--       Spam Check       --
if not VipMem(msg) and msg.content_.ID ~= "MessageChatAddMembers" and DevSOFI:hget(athalos.."SOFI:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= athalos then
floods = DevSOFI:hget(athalos.."SOFI:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = DevSOFI:hget(athalos.."SOFI:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = DevSOFI:hget(athalos.."SOFI:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(DevSOFI:get(athalos.."SOFI:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(DevSOFI:hget(athalos.."SOFI:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = DevSOFI:hget(athalos.."SOFI:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
DevSOFI:setex(athalos.."SOFI:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(DevSOFI:hget(athalos.."SOFI:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if DevSOFI:hget(athalos.."SOFI:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = DevSOFI:hget(athalos.."SOFI:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if DevSOFI:hget(athalos.."SOFI:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = DevSOFI:hget(athalos.."SOFI:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--     Source athalos     --
...
if Constructor(msg) or tonumber(msg.sender_user_id_) == tonumber(athalos) then
DevSOFI:set(athalos..'SOFI:PinnedMsg'..msg.chat_id_,msg.content_.message_id_)
else
local pin_id = DevSOFI:get(athalos..'SOFI:PinnedMsg'..msg.chat_id_)
if pin_id and DevSOFI:get(athalos..'SOFI:Lock:Pin'..msg.chat_id_) then
pinmsg(msg.chat_id_,pin_id,0)
end
end
end
if DevSOFI:get(athalos..'SOFI:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
DevSOFI:del(athalos..'SOFI:viewget'..msg.sender_user_id_)
else
...
if DevSOFI:get(athalos..'SOFI:Lock:Forwards'..msg.chat_id_) then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
if DevSOFI:get(athalos..'SOFI:Lock:Photo'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
if DevSOFI:get(athalos..'SOFI:Lock:Links'..msg.chat_id_) then
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if DevSOFI:get(athalos..'SOFI:Lock:Tags'..msg.chat_id_) then
if msg.content_.caption_:match("@") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("#") then
if DevSOFI:get(athalos..'SOFI:Lock:Hashtak'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match(".[Ii][Rr]") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match(".[Oo][Rr][Gg]") or msg.content_.caption_:match(".[Ii][Nn][Ff][Oo]") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Xx][Yy][Zz]") or msg.content_.caption_:match(".[Tt][Kk]") or msg.content_.ID == "MessageEntityTextUrl" or msg.content_.ID == "MessageEntityUrl" then
if DevSOFI:get(athalos..'SOFI:Lock:WebLinks'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[\216-\219][\128-\191]") then
if DevSOFI:get(athalos..'SOFI:Lock:Arabic'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[A-Z]") or msg.content_.caption_:match("[a-z]") then
if DevSOFI:get(athalos..'SOFI:Lock:English'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
...
if DevSOFI:get(athalos..'SOFI:Lock:Markdown'..msg.chat_id_) then
if not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevSOFI:get(athalos..'SOFI:Lock:Document'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if not VipMem(msg) then
if DevSOFI:get(athalos..'SOFI:Lock:Inline'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source athalos     --
...
elseif msg.content_.ID == "MessageSticker" then
if not VipMem(msg) then
if DevSOFI:get(athalos..'SOFI:Lock:Stickers'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevSOFI:get(athalos..'SOFI:Groups:Welcomes'..msg.chat_id_) then
Welcomes = DevSOFI:get(athalos..'SOFI:Groups:Welcomes'..msg.chat_id_)
else
Welcomes = '• نورت حبي \n• firstname \n• username'
end
local Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
local Welcomes = Welcomes:gsub('firstname',('['..result.first_name_..']' or ''))
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@Tl_300]'))
...
if not DevSOFI:get(athalos..'SOFI:Lock:BotWelcome') then 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = athalos,offset_ = 0,limit_ = 1},function(extra,SOFI,success) 
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@Tl_300]'))
Dev_SOFI(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source athalos     --
--        Contact         --
...
if DevSOFI:get(athalos..'SOFI:Lock:Contact'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source athalos     --
...
if DevSOFI:get(athalos..'SOFI:Lock:Music'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevSOFI:get(athalos..'SOFI:Lock:Voice'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevSOFI:get(athalos..'SOFI:Lock:Location'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
if msg.content_.caption_ then
...
if DevSOFI:get(athalos..'SOFI:Lock:Videos'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevSOFI:get(athalos..'SOFI:Lock:Gifs'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevSOFI:get(athalos..'SOFI:Lock:Text'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
...
if not DevSOFI:get(athalos..'SOFI:Spam:Text'..msg.chat_id_) then
sens = 400
else
sens = tonumber(DevSOFI:get(athalos..'SOFI:Spam:Text'..msg.chat_id_))
end
if DevSOFI:get(athalos..'SOFI:Lock:Spam'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
--     Source athalos     --
if DevSOFI:get(athalos.."SOFI:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"✧ : تم الغاء حفظ الرابط")       
DevSOFI:del(athalos.."SOFI:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) 
return false
end
if msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)") then
local Link = msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)")
DevSOFI:set(athalos.."SOFI:Groups:Links"..msg.chat_id_,Link)
...
if DevSOFI:get('athalosTeam:'..athalos.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevSOFI:del('athalosTeam:'..athalos..'id:user'..msg.chat_id_)  
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء الامر', 1, 'md')
DevSOFI:del('athalosTeam:'..athalos.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevSOFI:del('athalosTeam:'..athalos.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevSOFI:get('athalosTeam:'..athalos..'id:user'..msg.chat_id_)  
DevSOFI:incrby(athalos..'SOFI:UsersMsgs'..msg.chat_id_..':'..iduserr,numadded)
Dev_SOFI(msg.chat_id_, msg.id_,  1, "✧ : تم اضافة "..numadded..' رساله', 1, 'md')
DevSOFI:del('athalosTeam:'..athalos..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
if DevSOFI:get('athalosTeam:'..athalos.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevSOFI:del('athalosTeam:'..athalos..'ids:user'..msg.chat_id_)  
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء الامر', 1, 'md')
DevSOFI:del('athalosTeam:'..athalos.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevSOFI:del('athalosTeam:'..athalos.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevSOFI:get('athalosTeam:'..athalos..'ids:user'..msg.chat_id_)  
DevSOFI:incrby(athalos..'SOFI:GamesNumber'..msg.chat_id_..iduserr,numadded)  
...
if not DevSOFI:get(athalos.."SOFI:Lock:Fshar"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if DevSOFI:get(athalos.."SOFI:Lock:Farsi"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","✧ : ممنوع التكلم بالغه الفارسيه هنا")  
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
if DevSOFI:get(athalos.."SOFI:Lock:FarsiBan"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ChatKick(msg.chat_id_, msg.sender_user_id_)
end end 
if text and (text:match("خره بالله") or text:match("خبربك") or text:match("كسدينربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خره بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("خرهبدينك") or text:match("كسالله") or text:match("خربالله")) then
if not DevSOFI:get(athalos.."SOFI:Lock:Kfr"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if not DevSOFI:get(athalos.."SOFI:Lock:Taf"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
local List = DevSOFI:smembers(athalos..'SOFI:Groups') 
local BotName = (DevSOFI:get(athalos.."SOFI:NameBot") or 'اثالوس')
local GetJson = '{"BotId": '..athalos..',"BotName": "'..BotName..'","GroupsList":{'  
for k,v in pairs(List) do 
LinkGroups = DevSOFI:get(athalos.."SOFI:Groups:Links"..v)
Welcomes = DevSOFI:get(athalos..'SOFI:Groups:Welcomes'..v) or ''
Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
SOFIConstructors = DevSOFI:smembers(athalos..'SOFI:SOFIConstructor:'..v)
Constructors = DevSOFI:smembers(athalos..'SOFI:BasicConstructor:'..v)
BasicConstructors = DevSOFI:smembers(athalos..'SOFI:Constructor:'..v)
Managers = DevSOFI:smembers(athalos..'SOFI:Managers:'..v)
Admis = DevSOFI:smembers(athalos..'SOFI:Admins:'..v)
Vips = DevSOFI:smembers(athalos..'SOFI:VipMem:'..v)
if k == 1 then
GetJson = GetJson..'"'..v..'":{'
else
GetJson = GetJson..',"'..v..'":{'
...
GetJson = GetJson..'}}'
local File = io.open('./'..athalos..'.json', "w")
File:write(GetJson)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..athalos..'.json', '✧ : يحتوي الملف على ↫ '..#List..' مجموعه',dl_cb, nil)
io.popen('rm -rf ./'..athalos..'.json')
end
...
--     Source athalos     --
if DevSOFI:get(athalos.."SET:GAME"..msg.chat_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
Dev_SOFI( msg.chat_id_, msg.id_, 1,"✧ : يوجد فقط ( 6 ) اختيارات\n✧ : ارسل اختيارك مره اخرى", 1, "md")    
return false  end 
local GETNUM = DevSOFI:get(athalos.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevSOFI:del(athalos.."SET:GAME"..msg.chat_id_)   
Dev_SOFI( msg.chat_id_, msg.id_, 1,'✧ : *المحيبس باليد رقم* ↫ '..NUM..'\n✧ : *مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, "md") 
DevSOFI:incrby(athalos..'SOFI:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
...
if DevSOFI:get(athalos..'DevSOFI4'..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, "✧ : تم الغاء الامر")
DevSOFI:del(athalos..'DevSOFI4'..msg.sender_user_id_)
return false  end 
DevSOFI:del(athalos..'DevSOFI4'..msg.sender_user_id_)
...
DevSOFI:set(athalos..'SOFI:ChId',data.id_)
else
...
--     Source athalos     --
if DevSOFI:get(athalos.."SOFI:DevText"..msg.chat_id_..":" .. msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
DevSOFI:del(athalos.."SOFI:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء الامر', 1, 'md')
return false 
end 
DevSOFI:del(athalos.."SOFI:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
local DevText = msg.content_.text_:match("(.*)")
DevSOFI:set(athalos.."DevText", DevText)
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم حفظ كليشة المطور", 1, "md")
end
if DevSOFI:get(athalos..'SOFI:NameBot'..msg.sender_user_id_) == 'msg' then
if text and text:match("^الغاء$") then 
DevSOFI:del(athalos..'SOFI:NameBot'..msg.sender_user_id_)
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء الامر', 1, 'md')
return false 
end 
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم حفظ اسم البوت ', 1, 'html')
DevSOFI:del(athalos..'SOFI:NameBot'..msg.sender_user_id_)
DevSOFI:set(athalos..'SOFI:NameBot', text)
return false 
end
--     Source athalos     --
if text == "الرابط" then
...
--     Source athalos     --
if text == "الرابط" then
if not DevSOFI:get(athalos.."SOFI:Lock:GpLinksinline"..msg.chat_id_) then 
...
NameBot = (DevSOFI:get(athalos..'SOFI:NameBot') or 'اثالوس')
local athalosTeam = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
DevSOFI2 = math.random(#athalosTeam) 
Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam[DevSOFI2] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevSOFI:get(athalos..'SOFI:NameBot') or 'اثالوس') 
local athalosTeam = {"اسمي القميل "..NameBot.." "} 
DevSOFI2 = math.random(#athalosTeam) 
Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam[DevSOFI2] , 1, 'html') 
return false
end
if text and text == (DevSOFI:get(athalos..'SOFI:NameBot') or 'اثالوس') then 
NameBot = (DevSOFI:get(athalos..'SOFI:NameBot') or 'اثالوس')
...
if tonumber((DevSOFI:get(athalos..'SOFI:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Dev_SOFI(msg.chat_id_, msg.id_, 1,'✧ : لم تربح اي نقطه\n✧ : ارسل ↫ الالعاب للعب', 1, 'md')
else 
Dev_SOFI(msg.chat_id_, msg.id_, 1,'✧ : عدد النقاط التي ربحتها ↫ '..(DevSOFI:get(athalos..'SOFI:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevSOFI:del(athalos..'SOFI:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevSOFI:del(athalos..'SOFI:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم حذف جميع نقاطك', 1, 'md') end
--     Source athalos     --
...
DevSOFI:set(athalos..'SOFI:GameNum'..msg.chat_id_,name)
DevSOFI:del(athalos..'SOFI:Games:Ids'..msg.chat_id_)
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
athalosTeam = '✧ : اول واحد يدز هذا السمايل يربح ↫ '..name
Dev_SOFI(msg.chat_id_, msg.id_, 1,athalosTeam, 1, 'md')
return false
end end
if text == DevSOFI:get(athalos..'SOFI:GameNum'..msg.chat_id_) and not DevSOFI:get(athalos..'SOFI:Games:Ids'..msg.chat_id_) then
if not DevSOFI:get(athalos..'SOFI:Games:Ids'..msg.chat_id_) then 
athalosTeam = '✧ : مبروك لقد ربحت في اللعبه \n✧ : ارسل ↫ سمايلات للعب مره اخرى'
Dev_SOFI(msg.chat_id_, msg.id_, 1,athalosTeam, 1, 'md')
DevSOFI:incrby(athalos..'SOFI:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
DevSOFI:set(athalos..'SOFI:Games:Ids'..msg.chat_id_,true)
end
...
athalosTeam = '✧ : اول واحد يرتبها يربح ↫ '..name
Dev_SOFI(msg.chat_id_, msg.id_, 1,athalosTeam, 1, 'md')
return false
end end
if text == DevSOFI:get(athalos..'SOFI:GameNum'..msg.chat_id_) and not DevSOFI:get(athalos..'SOFI:Games:Ids'..msg.chat_id_) then
...
if not DevSOFI:get(athalos..'SOFI:Lock:Games'..msg.chat_id_) then
Num = math.random(1,6)
DevSOFI:set(athalos.."GAMES"..msg.chat_id_,Num) 
TEST = [[
➀     ➁     ➂     ➃     ➄     ➅
↓     ↓     ↓     ↓     ↓     ↓
👊 ‹› 👊🏻 ‹› 👊🏼 ‹› 👊🏽 ‹› 👊🏾 ‹› 👊🏿
...
DevSOFI:setex(athalos.."SET:GAME"..msg.chat_id_, 100, true)  
return false  
end end
...
athalosTeam = '✧ : اول واحد يحلها يربح ↫ '..name
Dev_SOFI(msg.chat_id_, msg.id_, 1,athalosTeam, 1, 'md')
return false
end end
if text == DevSOFI:get(athalos..'SOFI:GameNum'..msg.chat_id_) and not DevSOFI:get(athalos..'SOFI:Games:Ids'..msg.chat_id_) then
...
name = DevSOFI2[math.random(#DevSOFI2)]
DevSOFI:set(athalos..'SOFI:GameNum2'..msg.chat_id_,name)
DevSOFI:del(athalos..'SOFI:Games:Ids'..msg.chat_id_)
...
athalosTeam = '✧ : ما معنى هذا السمايل :؟ ↫ '..name
Dev_SOFI(msg.chat_id_, msg.id_, 1,athalosTeam, 1, 'md')
return false
end end
if text == DevSOFI:get(athalos..'SOFI:GameNum2'..msg.chat_id_) and not DevSOFI:get(athalos..'SOFI:Games:Ids'..msg.chat_id_) then
if not DevSOFI:get(athalos..'SOFI:Games:Ids'..msg.chat_id_) then 
...
name = DevSOFI2[math.random(#DevSOFI2)]
DevSOFI:set(athalos..'SOFI:GameNum3'..msg.chat_id_,name)
DevSOFI:del(athalos..'SOFI:Games:Ids'..msg.chat_id_)
...
athalosTeam = '✧ : ما هو عكس كلمة ↫ '..name
Dev_SOFI(msg.chat_id_, msg.id_, 1,athalosTeam, 1, 'md')
return false
end end
if text == DevSOFI:get(athalos..'SOFI:GameNum3'..msg.chat_id_) and not DevSOFI:get(athalos..'SOFI:Games:Ids'..msg.chat_id_) then
if not DevSOFI:get(athalos..'SOFI:Games:Ids'..msg.chat_id_) then 
...
DevSOFI2 = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','📥','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧚‍♂️','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕓','🕤','⌛️','📅','👩‍⚖️','👨‍🎨'};
name = DevSOFI2[math.random(#DevSOFI2)]
DevSOFI:set(athalos..'SOFI:GameNum4'..msg.chat_id_,name)
DevSOFI:del(athalos..'SOFI:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'😸','😹😹😹😸😹😹😹😹')
name = string.gsub(name,'☠️','💀💀💀☠️💀💀💀💀')
name = string.gsub(name,'🐼','👻👻👻👻👻👻👻🐼')
...
name = string.gsub(name,'👩‍⚖️','👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👩‍⚖️👨‍⚖️👨‍⚖️')
name = string.gsub(name,'👨‍🎨','👩‍🎨👩‍🎨👨‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨')
athalosTeam = '✧ : اول واحد يطلع المختلف يربح\n{'..name..'} '
Dev_SOFI(msg.chat_id_, msg.id_, 1,athalosTeam, 1, 'md')
return false
end end
if text == DevSOFI:get(athalos..'SOFI:GameNum4'..msg.chat_id_) and not DevSOFI:get(athalos..'SOFI:Games:Ids'..msg.chat_id_) then
if not DevSOFI:get(athalos..'SOFI:Games:Ids'..msg.chat_id_) then 
...
name = DevSOFI2[math.random(#DevSOFI2)]
DevSOFI:set(athalos..'SOFI:GameNum5'..msg.chat_id_,name)
DevSOFI:del(athalos..'SOFI:Games:Ids'..msg.chat_id_)
...
athalosTeam = '✧ : اكمل المثال التالي ↫ ['..name..']'
Dev_SOFI(msg.chat_id_, msg.id_, 1,athalosTeam, 1, 'md')
return false
end end
if text == DevSOFI:get(athalos..'SOFI:GameNum5'..msg.chat_id_) then
if not DevSOFI:get(athalos..'SOFI:Games:Ids'..msg.chat_id_) then 
DevSOFI:incrby(athalos..'SOFI:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevSOFI:del(athalos..'SOFI:GameNum5'..msg.chat_id_)
...
name = DevSOFI2[math.random(#DevSOFI2)]
DevSOFI:set(athalos..'SOFI:GameNum6'..msg.chat_id_,name)
DevSOFI:del(athalos..'SOFI:Games:Ids'..msg.chat_id_)
...
athalosTeam = '✧ : اكمل المعادله التاليه ↫ ⤈\n{'..name..'} '
Dev_SOFI(msg.chat_id_, msg.id_, 1,athalosTeam, 1, 'md')
return false
end end
if text == DevSOFI:get(athalos..'SOFI:GameNum6'..msg.chat_id_) then
if not DevSOFI:get(athalos..'SOFI:Games:Ids'..msg.chat_id_) then 
DevSOFI:incrby(athalos..'SOFI:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevSOFI:del(athalos..'SOFI:GameNum6'..msg.chat_id_)
...
name = DevSOFI2[math.random(#DevSOFI2)]
DevSOFI:set(athalos..'SOFI:GameNum7'..msg.chat_id_,name)
DevSOFI:del(athalos..'SOFI:Games:Ids'..msg.chat_id_)
...
athalosTeam = '✧ : ما معنى كلمة ↫ '..name
Dev_SOFI(msg.chat_id_, msg.id_, 1,athalosTeam, 1, 'md')
return false
end end
if text == DevSOFI:get(athalos..'SOFI:GameNum7'..msg.chat_id_) then
if not DevSOFI:get(athalos..'SOFI:Games:Ids'..msg.chat_id_) then 
DevSOFI:incrby(athalos..'SOFI:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevSOFI:del(athalos..'SOFI:GameNum7'..msg.chat_id_)
...
name = DevSOFI2[math.random(#DevSOFI2)]
DevSOFI:set(athalos..'SOFI:GameNum8'..msg.chat_id_,name)
DevSOFI:del(athalos..'SOFI:Games:Ids'..msg.chat_id_)
...
if text == DevSOFI:get(athalos..'SOFI:GameNum8'..msg.chat_id_) then
if not DevSOFI:get(athalos..'SOFI:Games:Ids'..msg.chat_id_) then 
DevSOFI:incrby(athalos..'SOFI:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevSOFI:del(athalos..'SOFI:GameNum8'..msg.chat_id_)
...
--     Source athalos     --
if DevSOFI:get(athalos.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
Dev_SOFI(msg.chat_id_, msg.id_, 1,"✧ : عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
local GETNUM = DevSOFI:get(athalos.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevSOFI:del(athalos..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevSOFI:del(athalos.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
DevSOFI:incrby(athalos..'SOFI:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
Dev_SOFI(msg.chat_id_, msg.id_, 1,'✧ : *التخمين الصحيح هو* ↫ '..NUM..'\n✧ : *مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
DevSOFI:incrby(athalos..'Set:Num'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(DevSOFI:get(athalos..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
DevSOFI:del(athalos..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevSOFI:del(athalos.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
Dev_SOFI(msg.chat_id_, msg.id_, 1,'✧ : *التخمين الصحيح هو* ↫ '..GETNUM..'\n✧ : *للاسف لقد خسرت حاول مره اخرى لتخمين الرقم الصحيح*', 1, 'md')
else
if tonumber(DevSOFI:get(athalos..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 1 then
SetNum = 'محاولتان فقط'
elseif tonumber(DevSOFI:get(athalos..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 2 then
...
if not DevSOFI:get(athalos..'SOFI:Lock:Games'..msg.chat_id_) then
DevSOFI:del(athalos.."SOFI:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevSOFI:del(athalos..'SOFI:ListRolet'..msg.chat_id_)  
DevSOFI:setex(athalos.."SOFI:StartRolet"..msg.chat_id_..msg.sender_user_id_,3600,true)  
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and DevSOFI:get(athalos.."SOFI:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "✧ : لا استطيع بدء اللعبه بلاعب واحد فقط"
else
DevSOFI:set(athalos.."SOFI:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '✧ : تم بدء تسجيل اللسته يرجى ارسال المعرفات \n✧ : الفائز يحصل على 5 نقاط عدد المطلوبين ↫ '..text..' لاعب'
end
DevSOFI:del(athalos.."SOFI:StartRolet"..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,Text)
return false
end
if text and text:match('^(@[%a%d_]+)$') and DevSOFI:get(athalos.."SOFI:NumRolet"..msg.chat_id_..msg.sender_user_id_) then 
if DevSOFI:sismember(athalos..'SOFI:ListRolet'..msg.chat_id_,text) then
...
DevSOFI:sadd(athalos..'SOFI:ListRolet'..msg.chat_id_,text)
local CountAdd = DevSOFI:get(athalos.."SOFI:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = DevSOFI:scard(athalos..'SOFI:ListRolet'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
DevSOFI:del(athalos.."SOFI:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevSOFI:setex(athalos.."SOFI:WittingStartRolet"..msg.chat_id_..msg.sender_user_id_,1400,true) 
...
DevSOFI0 = (DevSOFI:get(athalos..'SOFI:GamesNumber'..msg.chat_id_..msg.sender_user_id_) * 50)
DevSOFI:incrby(athalos..'SOFI:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_,DevSOFI0)
Dev_SOFI(msg.chat_id_, msg.id_, 1,'✧ : تم بيع '..(DevSOFI:get(athalos..'SOFI:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n✧ : كل نقطه تساوي 50 رساله', 'md')
DevSOFI:del(athalos..'SOFI:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
--     Source athalos     --
...
DevSOFI:sadd(athalos..'SOFI:BasicConstructor:'..msg.chat_id_,Manager_id)  
DevSOFI:sadd(athalos..'SOFI:SOFIConstructor:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
if DevSOFI:get(athalos.."SOFI:Left:Bot"..athalos) then
...
ChatLeave(msg.chat_id_, athalos)
DevSOFI:srem(athalos.."SOFI:Groups",msg.chat_id_)
end
--     Source athalos     --
...
local msguser = tonumber(DevSOFI:get(athalos..'SOFI:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = DevSOFI:get(athalos..'SOFI:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(DevSOFI:get(athalos..'SOFI:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local user_nkt = tonumber(DevSOFI:get(athalos..'SOFI:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
if result.username_ then username = '@'..result.username_ else username = 'لا يوجد' end
...
DevSOFI:setex(athalos..'DevSOFI4'..msg.sender_user_id_,360,true)
...
function athalosTeam(extra,result,success)
if DevSOFI:get(athalos.."SOFI:Send:Bot"..athalos) and not SOFISudo(msg) then 
send(msg.chat_id_, msg.id_,"✧ : الاذاعه معطله من قبل المطور الاساسي")
return false
end
local GpList = DevSOFI:smembers(athalos.."SOFI:Groups")
for k,v in pairs(GpList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
local PvList = DevSOFI:smembers(athalos.."SOFI:Users")
for k,v in pairs(PvList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم اذاعة رسالتك بالتوجيه \n✧ : ‏في ↫ ❨ '..#GpList..' ❩ مجموعه \n✧ : والى ↫ ❨ '..#PvList..' ❩ مشترك \n ✓', 1, 'md')
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),athalosTeam)
end
end
--     Source athalos     --
if text == "مشاهده المنشور" and ChCheck(msg) or text == "مشاهدات المنشور" and ChCheck(msg) or text == "عدد المشاهدات" and ChCheck(msg) then
DevSOFI:set(athalos..'SOFI:viewget'..msg.sender_user_id_,true)
...
Text = [[
Welcome To Source
✧ : [athalos Team](https://t.me/Tl_300)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✧ Source Channel',url="https://t.me/Tl_300"}},
...
if DevSOFI:get(athalos.."SOFI:Kick:Me"..msg.chat_id_) then
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevSOFI:set(athalos..'yes'..msg.sender_user_id_, 'delyes')
DevSOFI:set(athalos..'no'..msg.sender_user_id_, 'delno')
...
DevSOFI:set(athalos.."SOFI:Kick:Me"..msg.chat_id_, true)
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل امر اطردني'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل اطردني' and Manager(msg) and ChCheck(msg) then
DevSOFI:del(athalos.."SOFI:Kick:Me"..msg.chat_id_)
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل امر اطردني'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
end
--     Source athalos     --
if text == "نزلني" and ChCheck(msg) then
if DevSOFI:get(athalos.."SOFI:Del:Me"..msg.chat_id_) then
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevSOFI:set(athalos..'yesdel'..msg.sender_user_id_, 'delyes')
DevSOFI:set(athalos..'nodel'..msg.sender_user_id_, 'delno')
...
DevSOFI:set(athalos.."SOFI:Del:Me"..msg.chat_id_, true)
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل امر نزلني'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل نزلني' and BasicConstructor(msg) and ChCheck(msg) then
DevSOFI:del(athalos.."SOFI:Del:Me"..msg.chat_id_)
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل امر نزلني'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
end
--     Source athalos     --
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Lock:TagAll'..msg.chat_id_)
end
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Lock:TagAll'..msg.chat_id_,true)
end
if Admin(msg) then
...
i = i + 1
if DevSOFI:get(athalos..'Save:UserName'..v.user_id_) then
text = text..i.."~ : [@"..DevSOFI:get(athalos..'Save:UserName'..v.user_id_).."]\n"
else
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos.."SOFI:Lock:TagAll")
end
if text == 'تعطيل ملف TagAll.lua' or text == 'تعطيل @all' or text == 'تعطيل all' or text == '↫ تعطيل all ✧' then   
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل ملف تاك منفصل للأعضاء'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos.."SOFI:Lock:TagAll",true) 
end 
if text and (text == "all" or text == "@all" or text == "#all") then
if (text and not DevSOFI:get(athalos.."SOFI:Lock:TagAll")) then
if DevSOFI:get(athalos.."SOFI:TagAll:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DevSOFI:setex(athalos..'SOFI:TagAll:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos.."SOFI:Lock:TagAdmins")
end
if text == 'تعطيل @admin' or text == 'تعطيل admin' or text == '↫ تعطيل admin ✧' then   
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل ملف تاك منفصل للمشرفين'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos.."SOFI:Lock:TagAdmins",true) 
end 
if text == "admin" or text == "@admin" or text == "#admin" then
if (text and not DevSOFI:get(athalos.."SOFI:Lock:TagAdmins")) then
if DevSOFI:get(athalos.."SOFI:TagAdmins:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DevSOFI:setex(athalos..'SOFI:TagAdmins:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
--     Source athalos     --
if (text and not DevSOFI:get(athalos.."SOFI:Lock:AutoFile")) then
Time = DevSOFI:get(athalos.."SOFI:AutoFile:Time")
if Time then 
...
Welcomes = DevSOFI:get(athalos..'SOFI:Groups:Welcomes'..v) or ''
SOFIConstructors = DevSOFI:smembers(athalos..'SOFI:SOFIConstructor:'..v)
BasicConstructors = DevSOFI:smembers(athalos..'SOFI:BasicConstructor:'..v)
Constructors = DevSOFI:smembers(athalos..'SOFI:Constructor:'..v)
Managers = DevSOFI:smembers(athalos..'SOFI:Managers:'..v)
Admis = DevSOFI:smembers(athalos..'SOFI:Admins:'..v)
Vips = DevSOFI:smembers(athalos..'SOFI:VipMem:'..v)
if k == 1 then
...
local curl = 'curl "' .. SOFI .. '" -F "chat_id='..DraGoN..'" -F "document=@'..athalos..'.json' .. '" -F "caption=✧ : نسخه تلقائيه تحتوي على ↫ '..#list..' مجموعه"'
io.popen(curl)
io.popen('fm -fr '..athalos..'.json')
DevSOFI:set(athalos.."SOFI:AutoFile:Time",os.date("%x"))
end
else 
DevSOFI:set(athalos.."SOFI:AutoFile:Time",os.date("%x"))
end
...
local EntryNumber = (DevSOFI:get(athalos..'SOFI:EntryNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local ExitNumber = (DevSOFI:get(athalos..'SOFI:ExitNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local MsgNumberDay = (DevSOFI:get(athalos..'SOFI:MsgNumberDay'..msg.chat_id_..':'..os.date('%d')) or 0)
...
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل تفاعلي'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:msg:SOFI'..msg.chat_id_) 
end
if text == "تفعيل تفاعلي" and Manager(msg) and ChCheck(msg) then
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل تفاعلي'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:msg:SOFI'..msg.chat_id_,true)  
end
if DevSOFI:get(athalos.."SOFI:msg:SOFI"..msg.chat_id_) then
if msg.content_.ID then
get_msg = DevSOFI:get(athalos.."SOFI:msg:SOFI"..msg.sender_user_id_..":"..msg.chat_id_) or 0
gms = get_msg + 1
DevSOFI:setex(athalos..'SOFI:msg:SOFI'..msg.sender_user_id_..":"..msg.chat_id_,86400,gms)
end
...
get_msg = DevSOFI:get(athalos.."SOFI:msg:SOFI"..result.sender_user_id_..":"..msg.chat_id_) or 0
...
--     Source athalos     --
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevSOFI:get(athalos..'SOFI:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevSOFI:get(athalos..'SOFI:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevSOFI:del(athalos..'SOFI:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevSOFI:del(athalos..'SOFI:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source athalos     --
if text and text:match('^هينه @(.*)') and ChCheck(msg) or text and text:match('^هينها @(.*)') and ChCheck(msg) then 
if not DevSOFI:get(athalos..'SOFI:Lock:Stupid'..msg.chat_id_) then
local username = text:match('^هينه @(.*)') or text:match('^هينها @(.*)') 
function athalosTeam(extra,result,success)
if result.id_ then  
if tonumber(result.id_) == tonumber(athalos) then  
Dev_SOFI(msg.chat_id_, msg.id_, 1, 'شو تمضرط اكو واحد يهين نفسه؟🤔👌🏿', 1, 'md')  
return false 
end  
if tonumber(result.id_) == tonumber(DraGoN) then 
...
if DevSOFI:sismember(athalos.."SOFI:SOFIConstructor:"..msg.chat_id_,result.id_) then
Dev_SOFI(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local athalosTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_SOFI(msg.chat_id_, msg.id_, 1,athalosTeam, 1, 'md') 
local athalosTeam = { "لكك جرجف @"..username.." احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش لكك فاشل @"..username.." لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","حبيبي @"..username.." راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪","دمشي لك @"..username.." ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع @"..username.." متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪",}
Dev_SOFI(msg.chat_id_, result.id_, 1,''..athalosTeam[math.random(#athalosTeam)], 1, 'html') 
else  
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : العضو غير موجود في المجموعه', 1, 'md') 
end 
end 
resolve_username(username,athalosTeam)
end
end
--     Source athalos     --
...
if tonumber(result.sender_user_id_) == tonumber(athalos) then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, 'شو تمضرط اكو واحد يهين نفسه؟🤔👌🏿', 1, 'md') 
return false  
end  
if tonumber(result.sender_user_id_) == tonumber(DraGoN) then  
Dev_SOFI(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
...
if DevSOFI:sismember(athalos.."SOFI:SOFIConstructor:"..msg.chat_id_,result.sender_user_id_) then
Dev_SOFI(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local athalosTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_SOFI(msg.chat_id_, msg.id_, 1,athalosTeam, 1, 'md') 
local athalosTeam = {"لكك جرجف احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش فاشل لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","دمشي لك ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪","حبيبي راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪"} 
Dev_SOFI(msg.chat_id_, result.id_, 1,''..athalosTeam[math.random(#athalosTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local athalosTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_SOFI(msg.chat_id_, msg.id_, 1,athalosTeam, 1, 'md') 
local athalosTeam = {"مواححح افيش عافيههه😍🔥💗","امممووااهحح شهلعسل🥺🍯💘","مواححح،ءوفف اذوب🤤💗"} 
Dev_SOFI(msg.chat_id_, result.id_, 1,''..athalosTeam[math.random(#athalosTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local athalosTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_SOFI(msg.chat_id_, msg.id_, 1,athalosTeam, 1, 'md') 
local athalosTeam = {"تتعال ححب محتاجيك🙂🍭","تعال يولل استاذكك ايريدككك😒🔪","يمعوود تعاال يريدوكك🤕♥️","تعال لكك ديصيحوك😐🖤"} 
Dev_SOFI(msg.chat_id_, result.id_, 1,''..athalosTeam[math.random(#athalosTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local athalosTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_SOFI(msg.chat_id_, msg.id_, 1,athalosTeam, 1, 'md') 
local athalosTeam = { "تتعال ححب @"..username.." محتاجيك🙂🍭","تعال يولل @"..username.." استاذكك ايريدككك😒🔪","يمعوود @"..username.." تعاال يريدوكك🤕♥️","تعال لكك @"..username.." ديصيحوك😐🖤",}
Dev_SOFI(msg.chat_id_, result.id_, 1,''..athalosTeam[math.random(#athalosTeam)], 1, 'html') 
else  
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : العضو غير موجود في المجموعه', 1, 'md') 
end 
...
if DevSOFI:sismember(athalos..'SOFI:SOFISudo:',result.sender_user_id_) then
SOFIsudo = 'المطورين الاساسيين • ' else SOFIsudo = '' end
if DevSOFI:sismember(athalos..'SOFI:SecondSudo:',result.sender_user_id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevSOFI:sismember(athalos..'SOFI:SudoBot:',result.sender_user_id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevSOFI:sismember(athalos..'SOFI:BasicConstructor:'..msg.chat_id_, result.sender_user_id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevSOFI:sismember(athalos..'SOFI:Constructor:'..msg.chat_id_, result.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevSOFI:sismember(athalos..'SOFI:Managers:'..msg.chat_id_, result.sender_user_id_) then
manager = 'المدراء • ' else manager = '' end
if DevSOFI:sismember(athalos..'SOFI:Admins:'..msg.chat_id_, result.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevSOFI:sismember(athalos..'SOFI:VipMem:'..msg.chat_id_, result.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevSOFI:sismember(athalos..'SOFI:Cleaner:'..msg.chat_id_, result.sender_user_id_) then
...
DevSOFI:srem(athalos..'SOFI:SOFISudo:', result.sender_user_id_)
DevSOFI:srem(athalos..'SOFI:SecondSudo:', result.sender_user_id_)
DevSOFI:srem(athalos..'SOFI:SudoBot:', result.sender_user_id_)
DevSOFI:srem(athalos..'SOFI:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
DevSOFI:srem(athalos..'SOFI:Constructor:'..msg.chat_id_,result.sender_user_id_)
DevSOFI:srem(athalos..'SOFI:Managers:'..msg.chat_id_, result.sender_user_id_)
DevSOFI:srem(athalos..'SOFI:Admins:'..msg.chat_id_, result.sender_user_id_)
DevSOFI:srem(athalos..'SOFI:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevSOFI:srem(athalos..'SOFI:Cleaner:'..msg.chat_id_, result.sender_user_id_)
...
if DevSOFI:sismember(athalos..'SOFI:SOFISudo:',result.id_) then
SOFIsudo = 'المطورين الاساسيين • ' else SOFIsudo = '' end
if DevSOFI:sismember(athalos..'SOFI:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevSOFI:sismember(athalos..'SOFI:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevSOFI:sismember(athalos..'SOFI:BasicConstructor:'..msg.chat_id_, result.id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevSOFI:sismember(athalos..'SOFI:Constructor:'..msg.chat_id_, result.id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevSOFI:sismember(athalos..'SOFI:Managers:'..msg.chat_id_, result.id_) then
manager = 'المدراء • ' else manager = '' end
if DevSOFI:sismember(athalos..'SOFI:Admins:'..msg.chat_id_, result.id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevSOFI:sismember(athalos..'SOFI:VipMem:'..msg.chat_id_, result.id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevSOFI:sismember(athalos..'SOFI:Cleaner:'..msg.chat_id_, result.id_) then
cleaner = 'المنظفين • ' else cleaner = ''
end
...
if SOFIDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
DevSOFI:srem(athalos..'SOFI:SOFISudo:', result.id_)
DevSOFI:srem(athalos..'SOFI:SecondSudo:', result.id_)
DevSOFI:srem(athalos..'SOFI:SudoBot:', result.id_)
DevSOFI:srem(athalos..'SOFI:BasicConstructor:'..msg.chat_id_,result.id_)
DevSOFI:srem(athalos..'SOFI:Constructor:'..msg.chat_id_,result.id_)
DevSOFI:srem(athalos..'SOFI:Managers:'..msg.chat_id_, result.id_)
DevSOFI:srem(athalos..'SOFI:Admins:'..msg.chat_id_, result.id_)
DevSOFI:srem(athalos..'SOFI:VipMem:'..msg.chat_id_, result.id_)
DevSOFI:srem(athalos..'SOFI:Cleaner:'..msg.chat_id_, result.id_)
elseif SOFIDelAll(msg.sender_user_id_,msg.chat_id_) == 'SOFIsudo' then
DevSOFI:srem(athalos..'SOFI:SecondSudo:', result.id_)
DevSOFI:srem(athalos..'SOFI:SudoBot:', result.id_)
DevSOFI:srem(athalos..'SOFI:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevSOFI:sadd(athalos..'SOFI:SOFISudo:',result.sender_user_id_)
...
if result.id_ then
DevSOFI:sadd(athalos..'SOFI:SOFISudo:',result.id_)
...
DevSOFI:sadd(athalos..'SOFI:SOFISudo:',user)
...
DevSOFI:srem(athalos..'SOFI:SOFISudo:',user)
...
function sudo_reply(extra, result, success)
DevSOFI:sadd(athalos..'SOFI:SecondSudo:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevSOFI:sadd(athalos..'SOFI:SecondSudo:',result.id_)
...
DevSOFI:sadd(athalos..'SOFI:SecondSudo:',user)
...
DevSOFI:srem(athalos..'SOFI:SecondSudo:',user)
...
function sudo_reply(extra, result, success)
DevSOFI:sadd(athalos..'SOFI:SudoBot:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevSOFI:sadd(athalos..'SOFI:SudoBot:',result.id_)
...
DevSOFI:sadd(athalos..'SOFI:SudoBot:',user)
...
DevSOFI:srem(athalos..'SOFI:SudoBot:',user)
...
DevSOFI:sadd(athalos..'SOFI:Owner:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevSOFI:sadd(athalos..'SOFI:Owner:'..msg.chat_id_,result.id_)
...
DevSOFI:sadd(athalos..'SOFI:Owner:'..msg.chat_id_,user)
...
DevSOFI:srem(athalos..'SOFI:Owner:'..msg.chat_id_,result.sender_user_id_)
...
DevSOFI:srem(athalos..'SOFI:Owner:'..msg.chat_id_,result.id_)
...
DevSOFI:srem(athalos..'SOFI:Owner:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
if not SOFIConstructor(msg) and DevSOFI:get(athalos.."SOFI:Lock:ProSet"..msg.chat_id_) then 
Dev_SOFI(msg.chat_id_, msg.id_, 1,'✧ : لاتستطيع رفع احد وذالك بسبب تعطيل الرفع', 1, 'md')
return false
end
DevSOFI:sadd(athalos..'SOFI:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevSOFI:sadd(athalos..'SOFI:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevSOFI:sadd(athalos..'SOFI:BasicConstructor:'..msg.chat_id_,user)
...
DevSOFI:srem(athalos..'SOFI:BasicConstructor:'..msg.chat_id_,user)
...
DevSOFI:sadd(athalos..'SOFI:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevSOFI:sadd(athalos..'SOFI:Constructor:'..msg.chat_id_,result.id_)
...
DevSOFI:sadd(athalos..'SOFI:Constructor:'..msg.chat_id_,user)
...
DevSOFI:srem(athalos..'SOFI:Constructor:'..msg.chat_id_,user)
...
DevSOFI:sadd(athalos..'SOFI:Managers:'..msg.chat_id_,user)
...
DevSOFI:srem(athalos..'SOFI:Managers:'..msg.chat_id_,user)
...
DevSOFI:sadd(athalos..'SOFI:Cleaner:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevSOFI:sadd(athalos..'SOFI:Cleaner:'..msg.chat_id_,result.id_)
...
DevSOFI:sadd(athalos..'SOFI:Cleaner:'..msg.chat_id_,user)
...
DevSOFI:srem(athalos..'SOFI:Cleaner:'..msg.chat_id_,user)
...
DevSOFI:sadd(athalos..'SOFI:Admins:'..msg.chat_id_,user)
...
DevSOFI:srem(athalos..'SOFI:Admins:'..msg.chat_id_,user)
...
DevSOFI:sadd(athalos..'SOFI:VipMem:'..msg.chat_id_,user)
...
DevSOFI:srem(athalos..'SOFI:VipMem:'..msg.chat_id_,user)
...
function promote_by_reply(extra, result, success)
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChatMember?chat_id='..msg.chat_id_..'&user_id='..athalos)
local GetInfo = JSON.decode(Check)
...
athalosTeam = {"ها هلاو","انطق","كول","تفضل","احبك","عمري","لاف"};
send(msg.sender_user_id_, 0,athalosTeam[math.random(#athalosTeam)])
end
--     Source athalos     --
...
DevSOFI:del(athalos.."SOFI:Lock:KickBan"..msg.chat_id_)
...
DevSOFI:set(athalos.."SOFI:Lock:KickBan"..msg.chat_id_,"true")
...
DevSOFI:del(athalos.."SOFI:Lock:MuteTked"..msg.chat_id_)
...
DevSOFI:set(athalos.."SOFI:Lock:MuteTked"..msg.chat_id_,"true")
...
DevSOFI:del(athalos.."SOFI:Lock:ProSet"..msg.chat_id_)
...
DevSOFI:set(athalos.."SOFI:Lock:ProSet"..msg.chat_id_,"true")
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم تعطيل رفع ↫ المنشئ الاساسي • المنشئ • المدير • الادمن • المميز', 1, 'md')
end
end
--     Source athalos     --
...
if not SOFIConstructor(msg) and DevSOFI:get(athalos.."SOFI:Lock:KickBan"..msg.chat_id_) then 
...
ChatKick(result.chat_id_, result.sender_user_id_)
DevSOFI:sadd(athalos..'SOFI:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if not Constructor(msg) and DevSOFI:get(athalos.."SOFI:Lock:KickBan"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'✧ : لقد تم تعطيل الطرد والحظر من قبل مالك المجموعه')
return false
end
if result.id_ then
...
ChatKick(msg.chat_id_, result.id_)
DevSOFI:sadd(athalos..'SOFI:Ban:'..msg.chat_id_, result.id_)
...
ChatKick(msg.chat_id_, user)
DevSOFI:sadd(athalos..'SOFI:Ban:'..msg.chat_id_, user)
...
DevSOFI:srem(athalos..'SOFI:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
DevSOFI:srem(athalos..'SOFI:Ban:'..msg.chat_id_, result.id_)
...
DevSOFI:srem(athalos..'SOFI:Ban:'..msg.chat_id_, user)
...
if not SOFIConstructor(msg) and DevSOFI:get(athalos.."SOFI:Lock:MuteTked"..msg.chat_id_) then 
...
if DevSOFI:sismember(athalos..'SOFI:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✧ : هو بالفعل مكتوم من المجموعه")  
else
DevSOFI:sadd(athalos..'SOFI:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if DevSOFI:sismember(athalos..'SOFI:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","✧ : هو بالفعل مكتوم من المجموعه")  
else
DevSOFI:sadd(athalos..'SOFI:Muted:'..msg.chat_id_, result.id_)
...
if DevSOFI:sismember(athalos..'SOFI:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","✧ : هو بالفعل مكتوم من المجموعه")  
else
DevSOFI:sadd(athalos..'SOFI:Muted:'..msg.chat_id_, user)
...
if not DevSOFI:sismember(athalos..'SOFI:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✧ : هو ليس مكتوم لالغاء كتمه")  
else
DevSOFI:srem(athalos..'SOFI:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if not DevSOFI:sismember(athalos..'SOFI:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","✧ : هو ليس مكتوم لالغاء كتمه")  
else
DevSOFI:srem(athalos..'SOFI:Muted:'..msg.chat_id_, result.id_)
...
if not DevSOFI:sismember(athalos..'SOFI:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","✧ : هو ليس مكتوم لالغاء كتمه")  
else
DevSOFI:srem(athalos..'SOFI:Muted:'..msg.chat_id_, user)
...
DevSOFI:sadd(athalos..'SOFI:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevSOFI:sadd(athalos..'SOFI:Tkeed:'..msg.chat_id_, result.id_)
...
DevSOFI:sadd(athalos..'SOFI:Tkeed:'..msg.chat_id_, user)
...
DevSOFI:srem(athalos..'SOFI:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevSOFI:srem(athalos..'SOFI:Tkeed:'..msg.chat_id_, result.id_)
...
DevSOFI:srem(athalos..'SOFI:Tkeed:'..msg.chat_id_, user)
...
if DevSOFI:sismember(athalos..'SOFI:SOFISudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : *لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevSOFI:sismember(athalos..'SOFI:SecondSudo:',result.sender_user_id_) and not SOFISudo(msg) then
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : *لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
DevSOFI:sadd(athalos..'SOFI:BanAll:', result.sender_user_id_)
...
if DevSOFI:sismember(athalos..'SOFI:SOFISudo:',result.id_) and not Sudo(msg) then
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : *لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevSOFI:sismember(athalos..'SOFI:SecondSudo:',result.id_) and not SOFISudo(msg) then
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : *لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
if result.id_ then
ChatKick(msg.chat_id_, result.id_)
DevSOFI:sadd(athalos..'SOFI:BanAll:', result.id_)
...
if tonumber(user) == tonumber(athalos) then  
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : *لاتستطيع حظر البوت عام*", 1, 'md')
return false 
end
...
if DevSOFI:sismember(athalos..'SOFI:SOFISudo:',user) and not Sudo(msg) then
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : *لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevSOFI:sismember(athalos..'SOFI:SecondSudo:',user) and not SOFISudo(msg) then
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : *لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
DevSOFI:sadd(athalos..'SOFI:BanAll:', user)
...
DevSOFI:sadd(athalos..'SOFI:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevSOFI:sadd(athalos..'SOFI:MuteAll:', result.id_)
...
DevSOFI:sadd(athalos..'SOFI:MuteAll:', user)
...
DevSOFI:srem(athalos..'SOFI:BanAll:', result.sender_user_id_)
DevSOFI:srem(athalos..'SOFI:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevSOFI:srem(athalos..'SOFI:BanAll:', result.id_)
DevSOFI:srem(athalos..'SOFI:MuteAll:', result.id_)
...
DevSOFI:srem(athalos..'SOFI:BanAll:', user)
DevSOFI:srem(athalos..'SOFI:MuteAll:', user)
...
DevSOFI:setex(athalos.."SOFI:EditDev"..msg.sender_user_id_,300,true)
end
if DevSOFI:get(athalos.."SOFI:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,'✧ : تم الغاء امر تغير المطور الاساسي')
DevSOFI:del(athalos.."SOFI:EditDev"..msg.sender_user_id_)
return false
end
if text and text:match("^(%d+)$") then 
...
if dp.first_name_ ~= false then
DevSOFI:del(athalos.."SOFI:EditDev"..msg.sender_user_id_)
DevSOFI:set(athalos.."SOFI:NewDev"..msg.sender_user_id_,dp.id_)
...
--     Source athalos     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not DevSOFI:get(athalos..'SOFI:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if DevSOFI:sismember(athalos..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✧ : هو مطي شرفع منه بعد😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","✧ : تم رفعه في قائمة المطايه") 
DevSOFI:sadd(athalos..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
--     Source athalos     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not DevSOFI:get(athalos..'SOFI:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if not DevSOFI:sismember(athalos..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✧ : هو ليس مطي ليتم تنزيله") 
else
DevSOFI:srem(athalos..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
...
DevSOFI:set('athalosTeam:'..athalos..'id:user'..msg.chat_id_,TXT)  
DevSOFI:setex('athalosTeam:'..athalos.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevSOFI:del(athalos..'SOFI:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_) 
DevSOFI:incrby(athalos..'SOFI:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_,Num) 
...
DevSOFI:set('athalosTeam:'..athalos..'ids:user'..msg.chat_id_,TXT)  
DevSOFI:setex('athalosTeam:'..athalos.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
function Reply(extra, result, success)
DevSOFI:incrby(athalos..'SOFI:GamesNumber'..msg.chat_id_..result.sender_user_id_,Num) 
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
if DevSOFI:get(athalos..'SOFI:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevSOFI:sadd(athalos.."SOFI:cleaner"..msg.chat_id_, msg.id_) else DevSOFI:sadd(athalos.."SOFI:cleaner"..msg.chat_id_, msg.id_) end end end
if DevSOFI:get(athalos..'SOFI:Lock:CleanNum'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevSOFI:sadd(athalos.."SOFI:cleanernum"..msg.chat_id_, msg.id_) else DevSOFI:sadd(athalos.."SOFI:cleanernum"..msg.chat_id_, msg.id_) end end end
if DevSOFI:get(athalos..'SOFI:Lock:CleanMusic'..msg.chat_id_) then if msg.content_.voice_ or msg.content_.audio_ then if msg.reply_to_message_id_ ~= 0 then DevSOFI:sadd(athalos.."SOFI:cleanermusic"..msg.chat_id_, msg.id_) else DevSOFI:sadd(athalos.."SOFI:cleanermusic"..msg.chat_id_, msg.id_) end end end
if Manager(msg) and msg.reply_to_message_id_ ~= 0 then
if text and text:match("^تثبيت$") and ChCheck(msg) then 
if DevSOFI:sismember(athalos.."SOFI:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
...
if data.ID == "Ok" then
DevSOFI:set(athalos..'SOFI:PinnedMsg'..msg.chat_id_,msg.reply_to_message_id_)
...
if result.content_.sticker_ then
local idsticker = result.content_.sticker_.sticker_.persistent_id_
DevSOFI:srem(athalos.."SOFI:FilterSteckr"..msg.chat_id_,idsticker)
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevSOFI:srem(athalos.."SOFI:FilterPhoto"..msg.chat_id_,photo)
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevSOFI:srem(athalos.."SOFI:FilterAnimation"..msg.chat_id_,idanimation)
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Thwel:SOFI'..msg.chat_id_) 
end
if text and (text == "تعطيل تحويل الصيغ" or text == "تعطيل التحويل") and Manager(msg) and ChCheck(msg) then
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل تحويل الصيغ'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Thwel:SOFI'..msg.chat_id_,true)  
end
if text == 'تحويل' and not DevSOFI:get(athalos..'SOFI:Thwel:SOFI'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local user_msgs = DevSOFI:get(athalos..'SOFI:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
local user_nkt = tonumber(DevSOFI:get(athalos..'SOFI:GamesNumber'..msg.chat_id_..data.id_) or 0)
if DevSOFI:sismember(athalos..'SOFI:BanAll:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif DevSOFI:sismember(athalos..'SOFI:MuteAll:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif DevSOFI:sismember(athalos..'SOFI:Ban:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif DevSOFI:sismember(athalos..'SOFI:Muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif DevSOFI:sismember(athalos..'SOFI:Tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevSOFI:sismember(athalos..'SOFI:SudoBot:',result.sender_user_id_) and SudoBot(msg) then
sudobot = '\n✧ : عدد الكروبات ↫ '..(DevSOFI:get(athalos..'SOFI:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevSOFI:get(athalos..'SOFI:UsersMsgs'..msg.chat_id_..':'..res.id_) or 0
local user_nkt = tonumber(DevSOFI:get(athalos..'SOFI:GamesNumber'..msg.chat_id_..res.id_) or 0)
if DevSOFI:sismember(athalos..'SOFI:BanAll:',res.id_) then
Tkeed = 'محظور عام'
elseif DevSOFI:sismember(athalos..'SOFI:MuteAll:',res.id_) then
Tkeed = 'مكتوم عام'
elseif DevSOFI:sismember(athalos..'SOFI:Ban:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif DevSOFI:sismember(athalos..'SOFI:Muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif DevSOFI:sismember(athalos..'SOFI:Tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevSOFI:sismember(athalos..'SOFI:SudoBot:',res.id_) and SudoBot(msg) then
sudobot = '\n✧ : عدد الكروبات ↫ '..(DevSOFI:get(athalos..'SOFI:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevSOFI:get(athalos..'SOFI:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(DevSOFI:get(athalos..'SOFI:GamesNumber'..msg.chat_id_..iduser) or 0)
if DevSOFI:sismember(athalos..'SOFI:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif DevSOFI:sismember(athalos..'SOFI:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif DevSOFI:sismember(athalos..'SOFI:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif DevSOFI:sismember(athalos..'SOFI:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif DevSOFI:sismember(athalos..'SOFI:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevSOFI:sismember(athalos..'SOFI:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n✧ : عدد الكروبات ↫ '..(DevSOFI:get(athalos..'SOFI:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if DevSOFI:sismember(athalos..'SOFI:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevSOFI:sismember(athalos..'SOFI:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevSOFI:sismember(athalos..'SOFI:BanAll:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevSOFI:sismember(athalos..'SOFI:MuteAll:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevSOFI:sismember(athalos..'SOFI:Tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if DevSOFI:sismember(athalos..'SOFI:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevSOFI:sismember(athalos..'SOFI:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevSOFI:sismember(athalos..'SOFI:BanAll:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevSOFI:sismember(athalos..'SOFI:MuteAll:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevSOFI:sismember(athalos..'SOFI:Tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : الحظر العام ↫ '..banall..'\n✧ : الكتم العام ↫ '..muteall..'\n✧ : الحظر ↫ '..banned..'\n✧ : الكتم ↫ '..muted..'\n✧ : التقيد ↫ '..tkeed, 1, 'md')  
else
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : *المعرف غير صحيح*', 1, 'md')  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevSOFI:srem(athalos..'SOFI:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevSOFI:srem(athalos..'SOFI:Ban:'..msg.chat_id_,result.sender_user_id_) DevSOFI:srem(athalos..'SOFI:Muted:'..msg.chat_id_,result.sender_user_id_) DevSOFI:srem(athalos..'SOFI:BanAll:',result.sender_user_id_) DevSOFI:srem(athalos..'SOFI:MuteAll:',result.sender_user_id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevSOFI:srem(athalos..'SOFI:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevSOFI:srem(athalos..'SOFI:Ban:'..msg.chat_id_,result.sender_user_id_) DevSOFI:srem(athalos..'SOFI:Muted:'..msg.chat_id_,result.sender_user_id_) 
end
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),unbanreply) 
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevSOFI:srem(athalos..'SOFI:Tkeed:'..msg.chat_id_,user) DevSOFI:srem(athalos..'SOFI:Ban:'..msg.chat_id_,user) DevSOFI:srem(athalos..'SOFI:Muted:'..msg.chat_id_,user) DevSOFI:srem(athalos..'SOFI:BanAll:',user) DevSOFI:srem(athalos..'SOFI:MuteAll:',user)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevSOFI:srem(athalos..'SOFI:Tkeed:'..msg.chat_id_,user) DevSOFI:srem(athalos..'SOFI:Ban:'..msg.chat_id_,user) DevSOFI:srem(athalos..'SOFI:Muted:'..msg.chat_id_,user) 
end  
end,nil)  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevSOFI:srem(athalos..'SOFI:Tkeed:'..msg.chat_id_,result.id_) DevSOFI:srem(athalos..'SOFI:Ban:'..msg.chat_id_,result.id_) DevSOFI:srem(athalos..'SOFI:Muted:'..msg.chat_id_,result.id_) DevSOFI:srem(athalos..'SOFI:BanAll:',result.id_) DevSOFI:srem(athalos..'SOFI:MuteAll:',result.id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevSOFI:srem(athalos..'SOFI:Tkeed:'..msg.chat_id_,result.id_) DevSOFI:srem(athalos..'SOFI:Ban:'..msg.chat_id_,result.id_) DevSOFI:srem(athalos..'SOFI:Muted:'..msg.chat_id_,result.id_) 
end
end,nil)   
end  
...
DevSOFI:set(athalos.."SOFI:GpIds:Text"..msg.chat_id_,Text_Rand)
...
if text and DevSOFI:get("athalos:New:id:"..athalos..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء حفظ كليشة الايدي', 1, 'md')
DevSOFI:del("athalos:New:id:"..athalos..msg.sender_user_id_)
return false
end
DevSOFI:del("athalos:New:id:"..athalos..msg.sender_user_id_)
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم حفظ كليشة الايدي العامه', 1, 'md')
DevSOFI:set(athalos.."SOFI:AllIds:Text",text)
return false
end
...
DevSOFI:del(athalos.."SOFI:AllIds:Text")
end
end
--     Source athalos     --
...
if text and Manager(msg) and DevSOFI:get("athalos:New:id:"..athalos..msg.chat_id_..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء حفظ كليشة الايدي', 1, 'md')
DevSOFI:del("athalos:New:id:"..athalos..msg.chat_id_..msg.sender_user_id_)
return false
end
DevSOFI:del("athalos:New:id:"..athalos..msg.chat_id_..msg.sender_user_id_)
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم حفظ الكليشه الجديده', 1, 'md')
DevSOFI:set(athalos.."SOFI:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✧ : تم حذف كليشة الايدي")  
DevSOFI:del(athalos.."SOFI:GpIds:Text"..msg.chat_id_)
end
end
--     Source athalos     --
if msg.reply_to_message_id_ ~= 0 then
...
function athalosTeam(extra,SOFI,success)
...
local msgsday = DevSOFI:get(athalos..'SOFI:UsersMsgs'..athalos..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit_msg = DevSOFI:get(athalos..'SOFI:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevSOFI:get(athalos..'SOFI:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local user_nkt = tonumber(DevSOFI:get(athalos..'SOFI:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
local cont = (tonumber(DevSOFI:get(athalos..'SOFI:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if DevSOFI:get(athalos.."SOFI:AllIds:Text") then
newpicid = DevSOFI:get(athalos.."SOFI:AllIds:Text")
...
local new_id = DevSOFI:get(athalos.."SOFI:GpIds:Text"..msg.chat_id_)
...
if DevSOFI:get(athalos.."SOFI:AllIds:Text") then
newallid = DevSOFI:get(athalos.."SOFI:AllIds:Text")
...
if DevSOFI:get(athalos.."SOFI:AllIds:Text") then
notpicid = DevSOFI:get(athalos.."SOFI:AllIds:Text")
...
if not DevSOFI:get(athalos..'SOFI:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✧ : تم قفل التعديل")  
DevSOFI:set(athalos..'SOFI:Lock:EditMsgs'..msg.chat_id_,true)
else
...
DevSOFI:set(athalos.."SOFI:Lock:Bots"..msg.chat_id_,"del")  
end
if LockText[2] == "البوتات بالطرد" then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✧ : تم قفل البوتات بالطرد")  
DevSOFI:set(athalos.."SOFI:Lock:Bots"..msg.chat_id_,"kick")  
end
...
DevSOFI:set(athalos.."SOFI:Lock:Bots"..msg.chat_id_,"ked")  
end
if LockText[2] == "التكرار" or LockText[2] == "التكرار بالحذف" then 
DevSOFI:hset(athalos.."SOFI:Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✧ : تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
DevSOFI:hset(athalos.."SOFI:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
...
DevSOFI:hset(athalos.."SOFI:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✧ : تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
DevSOFI:hset(athalos.."SOFI:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✧ : تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
if LockText[2] == "التثبيت" then
if not DevSOFI:get(athalos..'SOFI:Lock:Pin'..msg.chat_id_) then
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  DevSOFI:set(athalos.."SOFI:PinnedMsg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✧ : تم قفل التثبيت")  
DevSOFI:set(athalos..'SOFI:Lock:Pin'..msg.chat_id_,true)
DevSOFI:sadd(athalos.."SOFI:Lock:Pinpin",msg.chat_id_) 
else
...
DevSOFI:hset(athalos.."SOFI:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,TextSpam) 
end
end
if text and (text:match("^ضع زمن التكرار (%d+)$") or text:match("^وضع زمن التكرار (%d+)$")) then  
local TextSpam = text:match("ضع زمن التكرار (%d+)$") or text:match("وضع زمن التكرار (%d+)$")
DevSOFI:hset(athalos.."SOFI:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,TextSpam) 
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Lock:Id:Photo'..msg.chat_id_)
end end
if text and text == 'تعطيل الايدي بالصوره' and ChCheck(msg) then
if DevSOFI:get(athalos..'SOFI:Lock:Id:Photo'..msg.chat_id_) then
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : الايدي بالصوره بالتاكيد معطل', 1, 'md')
else
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل الايدي بالصوره'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Lock:Id:Photo'..msg.chat_id_,true)
end end 
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if DevSOFI:get(athalos..'SOFI:Lock:Id'..msg.chat_id_) then
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : الايدي بالتاكيد معطل ', 1, 'md')
else
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل الايدي بنجاح'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Lock:Id'..msg.chat_id_,true)
end end
end
--     Source athalos     --
...
DevSOFI:setex(athalos.."SOFI:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
end
if text == 'انشاء رابط' and ChCheck(msg) or text == 'انشاء الرابط' and ChCheck(msg) then
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not DevSOFI:get(athalos.."SOFI:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
DevSOFI:set(athalos.."SOFI:Groups:Links"..msg.chat_id_,LinkGroup) 
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos.."SOFI:Lock:Welcome"..msg.chat_id_,true)
end
if text and text:match("^تعطيل الترحيب$") and ChCheck(msg) then
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل الترحيب بنجاح'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos.."SOFI:Lock:Welcome"..msg.chat_id_)
end
if DevSOFI:get(athalos..'SOFI:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء حفظ كليشة الترحيب', 1, 'md')
DevSOFI:del(athalos..'SOFI:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevSOFI:del(athalos..'SOFI:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
Welcomes = text:gsub('"',"") Welcomes = text:gsub("'","") Welcomes = text:gsub(",","") Welcomes = text:gsub("*","") Welcomes = text:gsub(";","") Welcomes = text:gsub("`","") Welcomes = text:gsub("{","") Welcomes = text:gsub("}","") 
DevSOFI:set(athalos..'SOFI:Groups:Welcomes'..msg.chat_id_,Welcomes)
...
DevSOFI:set(athalos..'SOFI:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الترحيب$") and ChCheck(msg) or text and text:match("^حذف ترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✧ : تم حذف الترحيب")  
DevSOFI:del(athalos..'SOFI:Groups:Welcomes'..msg.chat_id_)
end
if text and text:match("^جلب الترحيب$") and ChCheck(msg) or text and text:match("^جلب ترحيب$") and ChCheck(msg) or text and text:match("^الترحيب$") and ChCheck(msg) then
local Welcomes = DevSOFI:get(athalos..'SOFI:Groups:Welcomes'..msg.chat_id_)
if Welcomes then
Dev_SOFI(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
else
...
--     Source athalos     --
if DevSOFI:get(athalos..'SOFI:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم الغاء حفظ الوصف", 1, 'md')
DevSOFI:del(athalos..'SOFI:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevSOFI:del(athalos..'SOFI:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevSOFI:set(athalos..'SOFI:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
DevSOFI:set(athalos.."SOFI:SetFilters"..msg.sender_user_id_..msg.chat_id_,"add")  
return false  
end    
if DevSOFI:get(athalos.."SOFI:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "add" then
if text == 'الغاء' then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء امر المنع', 1, 'md')
DevSOFI:del(athalos.."SOFI:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم منع الكلمه ↫ "..text, 1, 'html')
DevSOFI:del(athalos.."SOFI:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
DevSOFI:hset(athalos..'SOFI:Filters:'..msg.chat_id_, text,'newword')
return false
end
if text and text == "الغاء منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : ارسل لي الكلمه الان", 1, 'md') 
DevSOFI:set(athalos.."SOFI:SetFilters"..msg.sender_user_id_..msg.chat_id_,"del")  
return false  
end    
if DevSOFI:get(athalos.."SOFI:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "del" then   
if text == 'الغاء' then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء امر الغاء المنع', 1, 'md')
DevSOFI:del(athalos.."SOFI:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not DevSOFI:hget(athalos..'SOFI:Filters:'..msg.chat_id_, text) then  
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
DevSOFI:del(athalos.."SOFI:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
DevSOFI:hdel(athalos..'SOFI:Filters:'..msg.chat_id_, text)
...
local gps = DevSOFI:scard(athalos.."SOFI:Groups") local users = DevSOFI:scard(athalos.."SOFI:Users") 
...
local users = DevSOFI:scard(athalos.."SOFI:Users")
...
local gps = DevSOFI:scard(athalos.."SOFI:Groups")
...
if not DevSOFI:get(athalos..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then  
...
DevSOFI:setex(athalos..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end 
end
...
local pv = DevSOFI:smembers(athalos.."SOFI:Users")
local sendok = 0
for i = 1, #pv do
...
DevSOFI:srem(athalos.."SOFI:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = DevSOFI:smembers(athalos.."SOFI:Groups")
local w = 0
local q = 0
for i = 1, #group do
tdcli_function({ID='GetChat',chat_id_ = group[i]},function(arg,data)
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
DevSOFI:srem(athalos.."SOFI:Groups",group[i]) 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = group[i], user_id_ = athalos, status_ = { ID = "ChatMemberStatusLeft" }, }, dl_cb, nil)
w = w + 1
end
...
local athalosgp2 = (w + q)
local athalosgp3 = #group - athalosgp2
if q == 0 then
athalosgp2 = ''
else
...
Dev_SOFI(msg.chat_id_, msg.id_, 1,'✧ : عدد الكروبات الان ↫ { '..#group..' }'..athalosgp1..athalosgp2..'\n✧ : العدد الحقيقي الان  ↫ ( '..athalosgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Lock:CleanNum'..msg.chat_id_,true)  
end
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Lock:CleanNum'..msg.chat_id_) 
end
...
DevSOFI:set(athalos..'SOFI:CleanNum'..msg.chat_id_,Num) 
end end 
if msg and DevSOFI:get(athalos..'SOFI:Lock:CleanNum'..msg.chat_id_) then
if DevSOFI:get(athalos..'SOFI:CleanNum'..msg.chat_id_) then CleanNum = DevSOFI:get(athalos..'SOFI:CleanNum'..msg.chat_id_) else CleanNum = 200 end
if DevSOFI:scard(athalos.."SOFI:cleanernum"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevSOFI:smembers(athalos.."SOFI:cleanernum"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevSOFI:del(athalos.."SOFI:cleanernum"..msg.chat_id_)
end 
end
if CleanerNum(msg) then
if DevSOFI:get(athalos..'SOFI:Lock:CleanNum'..msg.chat_id_) then 
if text == "التلقائي" and ChCheck(msg) or text == "عدد التلقائي" and ChCheck(msg) then 
local M = DevSOFI:scard(athalos.."SOFI:cleanernum"..msg.chat_id_)
if M ~= 0 then
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : عدد الميديا ↫ "..M.."\n✧ : الحذف التلقائي ↫ "..(DevSOFI:get(athalos..'SOFI:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل امسح بنجاح'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Lock:Clean'..msg.chat_id_,true)  
end
if text == "تعطيل امسح" and Constructor(msg) then
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل امسح بنجاح'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Lock:Clean'..msg.chat_id_) 
end
if Cleaner(msg) then
if DevSOFI:get(athalos..'SOFI:Lock:Clean'..msg.chat_id_) then 
if text == "الميديا" and ChCheck(msg) or text == "عدد الميديا" and ChCheck(msg) then 
local M = DevSOFI:scard(athalos.."SOFI:cleaner"..msg.chat_id_)
if M ~= 0 then
...
DevSOFI:del(athalos.."SOFI:cleaner"..msg.chat_id_)
else
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : لاتوجد ميديا هنا", 1, 'md') 
end end 
end
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Lock:CleanMusic'..msg.chat_id_,true)  
end
if text == "تعطيل مسح الاغاني" and Constructor(msg) then
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل مسح الاغاني بنجاح'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Lock:CleanMusic'..msg.chat_id_) 
end
if CleanerMusic(msg) then
if DevSOFI:get(athalos..'SOFI:Lock:CleanMusic'..msg.chat_id_) then 
if text == "الاغاني" and ChCheck(msg) or text == "عدد الاغاني" and ChCheck(msg) then 
local M = DevSOFI:scard(athalos.."SOFI:cleanermusic"..msg.chat_id_)
if M ~= 0 then
...
local List = DevSOFI:smembers(athalos.."SOFI:cleanermusic"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevSOFI:del(athalos.."SOFI:cleanermusic"..msg.chat_id_)
else
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : لاتوجد اغاني هنا", 1, 'md') 
end end end end
--     Source athalos     --
...
if DevSOFI:get(athalos..'SOFI:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✧ : تم فتح التعديل")  
DevSOFI:del(athalos..'SOFI:Lock:EditMsgs'..msg.chat_id_)
else
...
DevSOFI:del(athalos.."SOFI:Lock:Bots"..msg.chat_id_)  
end end
if UnLockText[2] == "التكرار" then 
DevSOFI:hdel(athalos.."SOFI:Spam:Group:User"..msg.chat_id_ ,"Spam:User")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✧ : تم فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if DevSOFI:get(athalos..'SOFI:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✧ : تم فتح التثبيت")  
DevSOFI:del(athalos..'SOFI:Lock:Pin'..msg.chat_id_)
DevSOFI:srem(athalos.."SOFI:Lock:Pinpin",msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:Text'..msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:Photo'..msg.chat_id_)
else
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : الصور بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الكلايش" then
if DevSOFI:get(athalos..'SOFI:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✧ : تم فتح الكلايش")  
DevSOFI:del(athalos..'SOFI:Lock:Spam'..msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:Join'..msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:Videos'..msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:Document'..msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:Inline'..msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:Markdown'..msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:Gifs'..msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:Music'..msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:Voice'..msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:Links'..msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:Location'..msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:Tags'..msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:Hashtak'..msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:Contact'..msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:WebLinks'..msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:Arabic'..msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:English'..msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:TagServr'..msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:Stickers'..msg.chat_id_)
else
...
DevSOFI:del(athalos..'SOFI:Lock:Forwards'..msg.chat_id_)
else
...
DevSOFI:set(athalos.."SOFI:Lock:Bots"..msg.chat_id_,"del") DevSOFI:hset(athalos.."SOFI:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'SOFI:Lock:Links','SOFI:Lock:Contact','SOFI:Lock:Forwards','SOFI:Lock:Videos','SOFI:Lock:Gifs','SOFI:Lock:EditMsgs','SOFI:Lock:Stickers','SOFI:Lock:Farsi','SOFI:Lock:Spam','SOFI:Lock:WebLinks','SOFI:Lock:Photo'}
for i,Lock in pairs(LockList) do
DevSOFI:set(athalos..Lock..msg.chat_id_,true)
end
...
DevSOFI:del(athalos..UnLock..msg.chat_id_)
end
...
DevSOFI:del(athalos..'SOFI:Lock:Fshar'..msg.chat_id_) DevSOFI:del(athalos..'SOFI:Lock:Taf'..msg.chat_id_) DevSOFI:del(athalos..'SOFI:Lock:Kfr'..msg.chat_id_) 
DevSOFI:set(athalos.."SOFI:Lock:Bots"..msg.chat_id_,"del") DevSOFI:hset(athalos.."SOFI:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
...
DevSOFI:set(athalos..'SOFI:Lock:Fshar'..msg.chat_id_,true) DevSOFI:set(athalos..'SOFI:Lock:Taf'..msg.chat_id_,true) DevSOFI:set(athalos..'SOFI:Lock:Kfr'..msg.chat_id_,true) DevSOFI:hdel(athalos.."SOFI:Spam:Group:User"..msg.chat_id_ ,"Spam:User") 
...
DevSOFI:set(athalos..'SOFI:Spam:Text'..msg.chat_id_,SetSpam)
...
DevSOFI:set(athalos.."SOFI:SudoBot:Rd"..msg.chat_id_,Text)
...
DevSOFI:set(athalos.."SOFI:BasicConstructor:Rd"..msg.chat_id_,Text)
...
DevSOFI:set(athalos.."SOFI:Constructor:Rd"..msg.chat_id_,Text)
...
DevSOFI:set(athalos.."SOFI:Managers:Rd"..msg.chat_id_,Text) 
...
DevSOFI:set(athalos.."SOFI:Admins:Rd"..msg.chat_id_,Text)
...
DevSOFI:set(athalos.."SOFI:VipMem:Rd"..msg.chat_id_,Text)
...
DevSOFI:set(athalos.."SOFI:Cleaner:Rd"..msg.chat_id_,Text)
...
DevSOFI:set(athalos.."SOFI:mem:Rd"..msg.chat_id_,Text)
...
DevSOFI:del(athalos.."SOFI:mem:Rd"..msg.chat_id_)
DevSOFI:del(athalos.."SOFI:Cleaner:Rd"..msg.chat_id_)
DevSOFI:del(athalos.."SOFI:VipMem:Rd"..msg.chat_id_)
DevSOFI:del(athalos.."SOFI:Admins:Rd"..msg.chat_id_)
DevSOFI:del(athalos.."SOFI:Managers:Rd"..msg.chat_id_)
DevSOFI:del(athalos.."SOFI:Constructor:Rd"..msg.chat_id_)
DevSOFI:del(athalos.."SOFI:BasicConstructor:Rd"..msg.chat_id_)
DevSOFI:del(athalos.."SOFI:SudoBot:Rd"..msg.chat_id_)
end
end
--     Source athalos     --
...
if tonumber(admins[i].user_id_) ~= tonumber(athalos) then
...
DevSOFI:del(athalos..'SOFI:SOFISudo:')
...
DevSOFI:srem(athalos..'SOFI:Tkeed:'..msg.chat_id_, v)
end 
...
DevSOFI:del(athalos..'SOFI:Filters:'..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:Filters:'..msg.chat_id_)
DevSOFI:del(athalos.."SOFI:FilterAnimation"..msg.chat_id_)
DevSOFI:del(athalos.."SOFI:FilterPhoto"..msg.chat_id_)
DevSOFI:del(athalos.."SOFI:FilterSteckr"..msg.chat_id_)
end
...
DevSOFI:del(athalos..'SOFI:Ban:'..msg.chat_id_) DevSOFI:del(athalos..'SOFI:Admins:'..msg.chat_id_) DevSOFI:del(athalos..'User:Donky:'..msg.chat_id_) DevSOFI:del(athalos..'SOFI:VipMem:'..msg.chat_id_) DevSOFI:del(athalos..'SOFI:Filters:'..msg.chat_id_) DevSOFI:del(athalos..'SOFI:Muted:'..msg.chat_id_)
...
local basicconstructor = DevSOFI:smembers(athalos..'SOFI:BasicConstructor:'..msg.chat_id_)
local constructor = DevSOFI:smembers(athalos..'SOFI:Constructor:'..msg.chat_id_)
local Managers = DevSOFI:smembers(athalos..'SOFI:Managers:'..msg.chat_id_)
local admins = DevSOFI:smembers(athalos..'SOFI:Admins:'..msg.chat_id_)
local vipmem = DevSOFI:smembers(athalos..'SOFI:VipMem:'..msg.chat_id_)
local donky = DevSOFI:smembers(athalos..'User:Donky:'..msg.chat_id_)
...
spam_c = DevSOFI:get(athalos..'SOFI:Spam:Text'..msg.chat_id_)
end
--     Source athalos     --
if DevSOFI:hget(athalos.."SOFI:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif DevSOFI:hget(athalos.."SOFI:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif DevSOFI:hget(athalos.."SOFI:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif DevSOFI:hget(athalos.."SOFI:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "مفتوح"     
end
--     Source athalos     --
if DevSOFI:get(athalos.."SOFI:Lock:Bots"..msg.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif DevSOFI:get(athalos.."SOFI:Lock:Bots"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif DevSOFI:get(athalos.."SOFI:Lock:Bots"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "مفتوحه"    
end
--     Source athalos     --
if DevSOFI:get(athalos..'SOFI:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if DevSOFI:get(athalos..'SOFI:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفله' else mute_in = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفله' else mute_voice = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفله' else mute_edit = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفله' else lock_pin = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفله' else lock_sticker = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if DevSOFI:get(athalos.."SOFI:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if DevSOFI:get(athalos..'SOFI:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if DevSOFI:get(athalos..'SOFI:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if DevSOFI:get(athalos..'SOFI:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
...
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل ميزة انطق'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Antk:SOFI'..msg.chat_id_) 
end
if text == "تعطيل انطق" and Manager(msg) and ChCheck(msg) then
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل ميزة انطق'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Antk:SOFI'..msg.chat_id_,true)  
end
if text and text:match("^انطق (.*)$") and not DevSOFI:get(athalos..'SOFI:Antk:SOFI'..msg.chat_id_) and ChCheck(msg) then
...
--     Source athalos     --
if DevSOFI:get(athalos..'SOFI:setrules'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء حفظ قوانين المجموعه', 1, 'md')
DevSOFI:del(athalos..'SOFI:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevSOFI:del(athalos..'SOFI:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
DevSOFI:set(athalos..'SOFI:rules'..msg.chat_id_,text)
...
DevSOFI:set(athalos..'SOFI:setrules'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
end
if text and text:match("^القوانين$") and ChCheck(msg) then
local rules = DevSOFI:get(athalos..'SOFI:rules'..msg.chat_id_)
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Zrf:SOFI'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل الزخرفه بنجاح'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Zrf:SOFI'..msg.chat_id_,true)  
end
if DevSOFI:get(athalos..'Zrf:SOFI'..msg.chat_id_..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء امر الزخرفه', 1, 'md')
DevSOFI:del(athalos..'Zrf:SOFI'..msg.chat_id_..msg.sender_user_id_)
return false  
end 
...
if not DevSOFI:get(athalos..'SOFI:Zrf:SOFI'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'الزخرفه' and ChCheck(msg) then  
DevSOFI:setex(athalos.."Zrf:SOFI"..msg.chat_id_..msg.sender_user_id_,300,true)
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Brg:SOFI'..msg.chat_id_) 
end
if text == "تعطيل الابراج" and Manager(msg) and ChCheck(msg) then
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل الابراج بنجاح'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Brg:SOFI'..msg.chat_id_,true)  
end
if not DevSOFI:get(athalos..'SOFI:Brg:SOFI'..msg.chat_id_) then
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Nsba:SOFI'..msg.chat_id_) 
end
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Nsba:SOFI'..msg.chat_id_,true)  
end
if not DevSOFI:get(athalos..'SOFI:Nsba:SOFI'..msg.chat_id_) then
if text == "نسبه الحب" and ChCheck(msg) or text == "نسبة الحب" and ChCheck(msg) then
DevSOFI:set(athalos..'LoveNsba:SOFI'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevSOFI:get(athalos..'LoveNsba:SOFI'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء امر نسبة الحب ', 1, 'md')
DevSOFI:del(athalos..'LoveNsba:SOFI'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
...
DevSOFI:set(athalos..'RyNsba:SOFI'..msg.chat_id_..msg.sender_user_id_,true)
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الخيانه" and text ~= "نسبة الخيانه" and text ~= "↫ نسبه الخيانه ✧" and DevSOFI:get(athalos..'RyNsba:SOFI'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء امر نسبة الخيانه ', 1, 'md')
DevSOFI:del(athalos..'RyNsba:SOFI'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
SOFI = math.random(0,100);
...
DevSOFI:set(athalos..'JNsba:SOFI'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : قم بارسل اسم الشخص لقياس نسبة جماله كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الجمال" and text ~= "نسبة الجمال" and text ~= "↫ نسبه الجمال ✧" and DevSOFI:get(athalos..'JNsba:SOFI'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء امر نسبة الجمال ', 1, 'md')
DevSOFI:del(athalos..'JNsba:SOFI'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
SOFI = math.random(0,100);
...
DevSOFI:set(athalos..'HataNsba:SOFI'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and text ~= "↫ نسبه الكره ✧" and DevSOFI:get(athalos..'HataNsba:SOFI'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء امر نسبة الكره ', 1, 'md')
DevSOFI:del(athalos..'HataNsba:SOFI'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
SOFI = math.random(0,100);
...
DevSOFI:set(athalos..'RjolaNsba:SOFI'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and text ~= "↫ نسبه الرجوله ✧" and DevSOFI:get(athalos..'RjolaNsba:SOFI'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء امر نسبة الرجوله ', 1, 'md')
DevSOFI:del(athalos..'RjolaNsba:SOFI'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
SOFI = math.random(0,100);
...
DevSOFI:set(athalos..'AnothaNsba:SOFI'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ روز', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and text ~= "↫ نسبه الانوثه ✧" and DevSOFI:get(athalos..'AnothaNsba:SOFI'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء امر نسبة الانوثه ', 1, 'md')
DevSOFI:del(athalos..'AnothaNsba:SOFI'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
SOFI = math.random(0,100);
...
DevSOFI:set(athalos..'StupidNsba:SOFI'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and text ~= "↫ نسبه الغباء ✧" and DevSOFI:get(athalos..'StupidNsba:SOFI'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, '✧ : تم الغاء امر نسبة الغباء ', 1, 'md')
DevSOFI:del(athalos..'StupidNsba:SOFI'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
SOFI = math.random(0,100);
...
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل حساب العمر'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Age:SOFI'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and ChCheck(msg) then
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل حساب العمر'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Age:SOFI'..msg.chat_id_,true)  
end
if not DevSOFI:get(athalos..'SOFI:Age:SOFI'..msg.chat_id_) then
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Mean:SOFI'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and ChCheck(msg) then
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل معاني الاسماء'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Mean:SOFI'..msg.chat_id_,true)  
end
if not DevSOFI:get(athalos..'SOFI:Mean:SOFI'..msg.chat_id_) then
...
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل المتحركه'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:gif:SOFI'..msg.chat_id_) 
end
if text == "تعطيل متحركه" and Manager(msg) and ChCheck(msg) or text == "تعطيل المتحركه" and Manager(msg) and ChCheck(msg) then
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل المتحركه'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:gif:SOFI'..msg.chat_id_,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ✧") and not DevSOFI:get(athalos..'SOFI:gif:SOFI'..msg.chat_id_) and ChCheck(msg) then
...
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل الميمز'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:memz:SOFI'..msg.chat_id_) 
end
if text == "تعطيل ميمز" and Manager(msg) and ChCheck(msg) or text == "تعطيل الميمز" and Manager(msg) and ChCheck(msg) then
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل الميمز'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:memz:SOFI'..msg.chat_id_,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ✧") and not DevSOFI:get(athalos..'SOFI:memz:SOFI'..msg.chat_id_) and ChCheck(msg) then
...
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل غنيلي'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Audios:SOFI'..msg.chat_id_) 
end
if text == "تعطيل غنيلي" and Manager(msg) and ChCheck(msg) then
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل غنيلي'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Audios:SOFI'..msg.chat_id_,true)  
end
if text and (text == "غنيلي" or text == "↫ غنيلي ✧") and not DevSOFI:get(athalos..'SOFI:Audios:SOFI'..msg.chat_id_) and ChCheck(msg) then
...
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل الاغاني'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:mp3:SOFI'..msg.chat_id_) 
end
if text == "تعطيل الاغاني" and Manager(msg) and ChCheck(msg) or text == "تعطيل اغنيه" and Manager(msg) and ChCheck(msg) then
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل الاغاني'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:mp3:SOFI'..msg.chat_id_,true)  
end
if text and (text == "اغنيه" or text == "↫ اغنيه ✧" or text == "اغاني") and not DevSOFI:get(athalos..'SOFI:mp3:SOFI'..msg.chat_id_) and ChCheck(msg) then
...
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل الريمكس'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Remix:SOFI'..msg.chat_id_) 
end
if text == "تعطيل ريمكس" and Manager(msg) and ChCheck(msg) or text == "تعطيل الريمكس" and Manager(msg) and ChCheck(msg) then
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل الريمكس'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Remix:SOFI'..msg.chat_id_,true)  
end
if text and (text == "ريمكس" or text == "↫ ريمكس ✧") and not DevSOFI:get(athalos..'SOFI:Remix:SOFI'..msg.chat_id_) and ChCheck(msg) then
...
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل الصوره'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Photo:SOFI'..msg.chat_id_) 
end
if text == "تعطيل صوره" and Manager(msg) and ChCheck(msg) or text == "تعطيل الصوره" and Manager(msg) and ChCheck(msg) then
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل الصوره'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Photo:SOFI'..msg.chat_id_,true)  
end
if text and (text == "صوره" or text == "↫ صوره ✧") and not DevSOFI:get(athalos..'SOFI:Photo:SOFI'..msg.chat_id_) and ChCheck(msg) then
...
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل الانمي'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Anime:SOFI'..msg.chat_id_) 
end
if text == "تعطيل انمي" and Manager(msg) and ChCheck(msg) or text == "تعطيل الانمي" and Manager(msg) and ChCheck(msg) then
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل الانمي'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Anime:SOFI'..msg.chat_id_,true)  
end
if text and (text == "انمي" or text == "↫ انمي ✧") and not DevSOFI:get(athalos..'SOFI:Anime:SOFI'..msg.chat_id_) and ChCheck(msg) then
...
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل الافلام'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Movies:SOFI'..msg.chat_id_) 
end
if text == "تعطيل فلم" and Manager(msg) and ChCheck(msg) then
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل الافلام'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Movies:SOFI'..msg.chat_id_,true)  
end
if text and (text == "فلم" or text == "↫ فلم ✧") and not DevSOFI:get(athalos..'SOFI:Movies:SOFI'..msg.chat_id_) and ChCheck(msg) then
...
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل المسلسلات'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Series:SOFI'..msg.chat_id_) 
end
if text == "تعطيل مسلسل" and Manager(msg) and ChCheck(msg) then
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل المسلسلات'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Series:SOFI'..msg.chat_id_,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ✧") and not DevSOFI:get(athalos..'SOFI:Series:SOFI'..msg.chat_id_) and ChCheck(msg) then
...
--     Source athalos     --
if Admin(msg) then
if DevSOFI:get(athalos..'SOFI:LockSettings'..msg.chat_id_) then 
if text == "الروابط" then if DevSOFI:get(athalos..'SOFI:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local athalosTeam = "\n" .."✧ : الروابط ↫ "..mute_links.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevSOFI:get(athalos..'SOFI:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local athalosTeam = "\n" .."✧ : المعرف ↫ "..lock_tag.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevSOFI:get(athalos..'SOFI:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local athalosTeam = "\n" .."✧ : المتحركه ↫ "..mute_gifs.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "الملصقات" then if DevSOFI:get(athalos..'SOFI:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local athalosTeam = "\n" .."✧ : الملصقات ↫ "..lock_sticker.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "الصور" then if DevSOFI:get(athalos..'SOFI:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local athalosTeam = "\n" .."✧ : الصور ↫ "..mute_photo.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevSOFI:get(athalos..'SOFI:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local athalosTeam = "\n" .."✧ : الفيديو ↫ "..mute_video.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "الاونلاين" then if DevSOFI:get(athalos..'SOFI:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local athalosTeam = "\n" .."✧ : الاونلاين ↫ "..mute_in.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "الدردشه" then if DevSOFI:get(athalos..'SOFI:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local athalosTeam = "\n" .."✧ : الدردشه ↫ "..mute_text.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevSOFI:get(athalos..'SOFI:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local athalosTeam = "\n" .."✧ : التوجيه ↫ "..lock_forward.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "الاغاني" then if DevSOFI:get(athalos..'SOFI:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local athalosTeam = "\n" .."✧ : الاغاني ↫ "..mute_music.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevSOFI:get(athalos..'SOFI:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local athalosTeam = "\n" .."✧ : الصوت ↫ "..mute_voice.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevSOFI:get(athalos..'SOFI:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local athalosTeam = "\n" .."✧ : الجهات ↫ "..lock_contact.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "الماركداون" then if DevSOFI:get(athalos..'SOFI:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local athalosTeam = "\n" .."✧ : الماركداون ↫ "..markdown.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "الهاشتاك" then if DevSOFI:get(athalos..'SOFI:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local athalosTeam = "\n" .."✧ : الهاشتاك ↫ "..lock_htag.."\n"Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "التعديل" then if DevSOFI:get(athalos..'SOFI:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local athalosTeam = "\n" .."✧ : التعديل ↫ "..mute_edit.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "التثبيت" then if DevSOFI:get(athalos..'SOFI:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local athalosTeam = "\n" .."✧ : التثبيت ↫ "..lock_pin.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "الاشعارات" then if DevSOFI:get(athalos..'SOFI:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local athalosTeam = "\n" .."✧ : الاشعارات ↫ "..lock_tgservice.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "الكلايش" then if DevSOFI:get(athalos..'SOFI:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local athalosTeam = "\n" .."✧ : الكلايش ↫ "..lock_spam.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "الدخول" then if DevSOFI:get(athalos..'SOFI:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local athalosTeam = "\n" .."✧ : الدخول ↫ "..lock_Join.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "الشبكات" then if DevSOFI:get(athalos..'SOFI:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local athalosTeam = "\n" .."✧ : الشبكات ↫ "..lock_wp.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "المواقع" then if DevSOFI:get(athalos..'SOFI:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local athalosTeam = "\n" .."✧ : المواقع ↫ "..lock_location.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "العربيه" then if DevSOFI:get(athalos..'SOFI:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local athalosTeam = "\n" .."✧ : العربيه ↫ "..lock_arabic.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "الانكليزيه" then if DevSOFI:get(athalos..'SOFI:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local athalosTeam = "\n" .."✧ : الانكليزيه ↫ "..lock_english.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "الكفر" then if DevSOFI:get(athalos..'SOFI:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local athalosTeam = "\n" .."✧ : الكفر ↫ "..lock_kaf.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "الفشار" then if DevSOFI:get(athalos..'SOFI:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local athalosTeam = "\n" .."✧ : الفشار ↫ "..lock_fshar.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
if text == "الطائفيه" then if DevSOFI:get(athalos..'SOFI:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local athalosTeam = "\n" .."✧ : الطائفيه ↫ "..lock_taf.."\n" Dev_SOFI(msg.chat_id_, msg.id_, 1, athalosTeam, 1, 'md') end
end
--     Source athalos     --
if text == 'تفعيل كشف الاعدادات' and ChCheck(msg) then 
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل كشف الاعدادات'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:LockSettings'..msg.chat_id_,true)  
end
if text == 'تعطيل كشف الاعدادات' and ChCheck(msg) then 
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل كشف الاعدادات'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:LockSettings'..msg.chat_id_) 
end
--     Source athalos     --
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Lock:Robot'..msg.chat_id_)
end
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Lock:Robot'..msg.chat_id_,true)
end
--     Source athalos     --
if text == 'تفعيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل ردود المدير'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Lock:GpRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل ردود المدير'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Lock:GpRed'..msg.chat_id_,true)
end
--     Source athalos     --
if text == 'تفعيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل ردود المطور'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Lock:AllRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل ردود المطور'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Lock:AllRed'..msg.chat_id_,true)
end
--     Source athalos     --
if SOFISudo(msg) then
...
--     Source athalos     --
if msg.content_.photo_ then
if DevSOFI:get(athalos..'SOFI:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
DevSOFI:del(athalos..'SOFI:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"✧ : ليست لدي صلاحية تغير معلومات المجموعه يرجى التحقق من الصلاحيات") 
DevSOFI:del(athalos..'SOFI:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevSOFI:set(athalos..'SOFI:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
--     Source athalos     --
...
if data.ID == "Ok" then
DevSOFI:del(athalos..'SOFI:PinnedMsg'..msg.chat_id_)
...
local PinId = DevSOFI:get(athalos..'SOFI:PinnedMsg'..msg.chat_id_)
if PinId then
...
DevSOFI:del(athalos..'SOFI:Ban:'..msg.chat_id_)
else
local x = 0
...
local ConstructorList = DevSOFI:scard(athalos.."SOFI:Constructor:"..ChatId) or 0
local BanedList = DevSOFI:scard(athalos.."SOFI:Ban:"..ChatId) or 0
local ManagerList = DevSOFI:scard(athalos.."SOFI:Managers:"..ChatId) or 0
local MutedList = DevSOFI:scard(athalos.."SOFI:Muted:"..ChatId) or 0
local TkeedList = DevSOFI:scard(athalos.."SOFI:SOFI:Tkeed:"..ChatId) or 0
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/Tl_300' end
...
ConstructorSOFI = "["..SOFI.first_name_.."](T.me/"..(SOFI.username_ or "Tl_300")..")"
else 
...
ChatLeave(dp.id_, athalos)
DevSOFI:srem(athalos.."SOFI:Groups", dp.id_)
else
...
DevSOFI:set(athalos..'SOFI:Num:Add:Bot',Num) 
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Lock:FreeBot'..athalos) 
end 
end
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Lock:FreeBot'..athalos,true) 
end 
end
if ChatType == 'sp' or ChatType == 'gp'  then
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Photo:Profile'..msg.chat_id_) 
end
if text == 'تفعيل صورتي' and Manager(msg) and ChCheck(msg) then  
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل صورتي بنجاح'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Photo:Profile'..msg.chat_id_,true)  
end
if text == 'تفعيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تفعيل اللعبه' and Manager(msg) and ChCheck(msg) then   
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل الالعاب بنجاح'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Lock:Games'..msg.chat_id_) 
end
if text == 'تعطيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تعطيل اللعبه' and Manager(msg) and ChCheck(msg) then  
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل الالعاب بنجاح'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Lock:Games'..msg.chat_id_,true)  
end
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos..'SOFI:Lock:Gamesinline'..msg.chat_id_) 
end
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos..'SOFI:Lock:Gamesinline'..msg.chat_id_,true)  
end
if text == "تفعيل الرابط" and ChCheck(msg) or text == "تفعيل جلب الرابط" and ChCheck(msg) then 
if Admin(msg) then
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل جلب رابط المجموعه'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos.."SOFI:Lock:GpLinks"..msg.chat_id_)
return false  
end
end
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos.."SOFI:Lock:GpLinks"..msg.chat_id_,"ok")
return false  
end
end
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos.."SOFI:Lock:GpLinksinline"..msg.chat_id_,"ok")
return false  
end
end
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos.."SOFI:Lock:GpLinksinline"..msg.chat_id_)
return false  
end
end
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos.."SOFI:Lock:GpRd"..msg.chat_id_)
return false  
end
end
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos.."SOFI:Lock:GpRd"..msg.chat_id_,true)
return false  
end
end
...
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تفعيل اضف رد'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos.."SOFI:Lock:Rd"..msg.chat_id_)
return false  
end
end
...
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم تعطيل اضف رد'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos.."SOFI:Lock:Rd"..msg.chat_id_,true)
return false  
end
end
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:set(athalos.."SOFI:Lock:Key"..msg.chat_id_,"ok")
return false  
end
end
...
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
DevSOFI:del(athalos.."SOFI:Lock:Key"..msg.chat_id_)
return false  
end
end
--     Source athalos     --
...
ReplyStatus(msg,result.id_,"ReplyBy","✧ : تم تفعيل المجموعه "..dp.title_)  
DevSOFI:sadd(athalos.."SOFI:Groups",msg.chat_id_)
if not DevSOFI:get(athalos..'SOFI:SudosGp'..msg.sender_user_id_..msg.chat_id_) and not SecondSudo(msg) then 
DevSOFI:incrby(athalos..'SOFI:Sudos'..msg.sender_user_id_,1)
DevSOFI:set(athalos..'SOFI:SudosGp'..msg.sender_user_id_..msg.chat_id_,"SOFI")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
if not DevSOFI:sismember(athalos..'SOFI:Groups',msg.chat_id_) then
...
DevSOFI:setex(athalos.."SOFI:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n✧ : للخروج ارسل ↫ ( الغاء ) \n ✓'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevSOFI:get(athalos.."SOFI:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevSOFI:del(athalos.."SOFI:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevSOFI:smembers(athalos..'SOFI:Users') 
if msg.content_.text_ then
for k,v in pairs(List) do 
SOFIText = "الرساله"
...
DevSOFI:setex(athalos.."SOFI:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n✧ : للخروج ارسل ↫ ( الغاء ) \n ✓'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevSOFI:get(athalos.."SOFI:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevSOFI:del(athalos.."SOFI:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevSOFI:smembers(athalos..'SOFI:Groups') 
if msg.content_.text_ then
for k,v in pairs(List) do 
SOFIText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
...
DevSOFI:setex(athalos.."SOFI:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : ارسل الرساله الان لتوجيها \n✧ : للخروج ارسل ↫ ( الغاء ) \n ✓'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevSOFI:get(athalos.."SOFI:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevSOFI:del(athalos.."SOFI:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevSOFI:smembers(athalos..'SOFI:Groups')   
for k,v in pairs(List) do  
...
DevSOFI:setex(athalos.."SOFI:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : ارسل الرساله الان لتوجيها \n✧ : للخروج ارسل ↫ ( الغاء ) \n ✓'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevSOFI:get(athalos.."SOFI:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevSOFI:del(athalos.."SOFI:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevSOFI:smembers(athalos..'SOFI:Users')   
for k,v in pairs(List) do  
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = msg.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end   
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم اذاعة رسالتك بالتوجيه \n✧ : ‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
...
DevSOFI:setex(athalos.."SOFI:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n✧ : للخروج ارسل ↫ ( الغاء ) \n ✓'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevSOFI:get(athalos.."SOFI:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == "الغاء" then   
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevSOFI:del(athalos.."SOFI:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
local List = DevSOFI:smembers(athalos.."SOFI:Groups") 
if msg.content_.text_ then
...
SOFIText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
DevSOFI:set(athalos..'SOFI:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
SOFIText = "الصوره"
sendPhoto(v, 0, 0, 1, nil, photo,(msg.content_.caption_ or ''))
DevSOFI:set(athalos..'SOFI:PinnedMsgs'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(List) do 
SOFIText = "المتحركه"
sendDocument(v, 0, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or ''))    
DevSOFI:set(athalos..'SOFI:PinnedMsgs'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.video_ then
for k,v in pairs(List) do 
SOFIText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
DevSOFI:set(athalos..'SOFI:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
SOFIText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
DevSOFI:set(athalos..'SOFI:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
SOFIText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
DevSOFI:set(athalos..'SOFI:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
SOFIText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
DevSOFI:set(athalos..'SOFI:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
SOFIText = "الملصق"
sendSticker(v, 0, 0, 1, nil, msg.content_.sticker_.sticker_.persistent_id_)   
DevSOFI:set(athalos..'SOFI:PinnedMsgs'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Bot(msg) and DevSOFI:get(athalos..'SOFI:Lock:Rd'..msg.chat_id_) then 
...
local List = DevSOFI:smembers(athalos..'SOFI:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : لا توجد ردود متعدده مضافه" ,  1, "md")
return false
end end
DevSOFI:set(athalos..'SOFI:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedod')
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : حسنا ارسل كلمة الرد اولا" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local DelGpRedRedod = DevSOFI:get(athalos..'SOFI:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if not DevSOFI:sismember(athalos..'SOFI:Manager:GpRedod'..msg.chat_id_,text) then
...
DevSOFI:set(athalos..'SOFI:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedods')
DevSOFI:set(athalos..'SOFI:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
return false
end end
...
DevSOFI:set(athalos..'SOFI:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedod')
...
DevSOFI:set(athalos..'SOFI:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SetGpRedod')
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : حسنا ارسل الكلمه الان" ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetGpRedod = DevSOFI:get(athalos..'SOFI:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
DevSOFI:set(athalos..'SOFI:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SaveGpRedod')
DevSOFI:set(athalos..'SOFI:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevSOFI:sadd(athalos..'SOFI:Manager:GpRedod'..msg.chat_id_,text)
return false
end end
--     Source athalos     --
...
local List = DevSOFI:smembers(athalos..'SOFI:Manager:GpRed'..msg.chat_id_)
if #List == 0 then
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : لا توجد ردود مضافه" ,  1, "md")
return false
end end
DevSOFI:set(athalos..'SOFI:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'DelGpRed')
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevSOFI:set(athalos..'SOFI:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SetGpRed')
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : حسنا ارسل الكلمه الان " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetGpRed = DevSOFI:get(athalos..'SOFI:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
...
DevSOFI:set(athalos..'DelManagerRep'..msg.chat_id_,text)
return false
end end
--     Source athalos     --
...
local List = DevSOFI:smembers(athalos.."SOFI:Sudo:AllRed")
if #List == 0 then
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : لا توجد ردود مضافه" ,  1, "md")
return false
end end
DevSOFI:set(athalos.."SOFI:Add:AllRed"..msg.sender_user_id_,'DelAllRed')
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevSOFI:set(athalos.."SOFI:Add:AllRed"..msg.sender_user_id_,'SetAllRed')
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : حسنا ارسل الكلمه الان " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetAllRed = DevSOFI:get(athalos.."SOFI:Add:AllRed"..msg.sender_user_id_)
...
DevSOFI:set(athalos.."DelSudoRep",text)
return false 
end end
--     Source athalos     --
...
if not Bot(msg) and DevSOFI:get(athalos..'SOFI:Lock:GpRd'..msg.chat_id_) then 
...
for k,v in pairs(redod) do
DevSOFI:del(athalos..'SOFI:Text:GpTexts'..v..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:Manager:GpRedod'..msg.chat_id_)
end
...
dp = 'متحركه 🎭'
elseif DevSOFI:get(athalos.."SOFI:Voice:GpRed"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif DevSOFI:get(athalos.."SOFI:Stecker:GpRed"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif DevSOFI:get(athalos.."SOFI:Text:GpRed"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif DevSOFI:get(athalos.."SOFI:Photo:GpRed"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif DevSOFI:get(athalos.."SOFI:Video:GpRed"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif DevSOFI:get(athalos.."SOFI:File:GpRed"..v..msg.chat_id_) then
dp = 'ملف 📁'
elseif DevSOFI:get(athalos.."SOFI:Audio:GpRed"..v..msg.chat_id_) then
dp = 'اغنيه 🎶'
end
...
for k,v in pairs(redod) do
DevSOFI:del(athalos..'SOFI:Gif:GpRed'..v..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:Voice:GpRed'..v..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:Audio:GpRed'..v..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:Photo:GpRed'..v..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:Stecker:GpRed'..v..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:Video:GpRed'..v..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:File:GpRed'..v..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:Text:GpRed'..v..msg.chat_id_)
DevSOFI:del(athalos..'SOFI:Manager:GpRed'..msg.chat_id_)
end
...
dp = 'متحركه 🎭'
elseif DevSOFI:get(athalos.."SOFI:Voice:AllRed"..v) then
dp = 'بصمه 🎙'
elseif DevSOFI:get(athalos.."SOFI:Stecker:AllRed"..v) then
dp = 'ملصق 🃏'
elseif DevSOFI:get(athalos.."SOFI:Text:AllRed"..v) then
dp = 'رساله ✉'
elseif DevSOFI:get(athalos.."SOFI:Photo:AllRed"..v) then
dp = 'صوره 🎇'
elseif DevSOFI:get(athalos.."SOFI:Video:AllRed"..v) then
dp = 'فيديو 📽'
elseif DevSOFI:get(athalos.."SOFI:File:AllRed"..v) then
dp = 'ملف 📁'
elseif DevSOFI:get(athalos.."SOFI:Audio:AllRed"..v) then
dp = 'اغنيه 🎶'
end
MsgRep = MsgRep..k..'~ (`'..v..'`) ↫ {*'..dp..'*}\n' 
end
...
for k,v in pairs(redod) do
DevSOFI:del(athalos.."SOFI:Add:AllRed"..v)
DevSOFI:del(athalos.."SOFI:Gif:AllRed"..v)
DevSOFI:del(athalos.."SOFI:Voice:AllRed"..v)
DevSOFI:del(athalos.."SOFI:Audio:AllRed"..v)
DevSOFI:del(athalos.."SOFI:Photo:AllRed"..v)
DevSOFI:del(athalos.."SOFI:Stecker:AllRed"..v)
DevSOFI:del(athalos.."SOFI:Video:AllRed"..v)
DevSOFI:del(athalos.."SOFI:File:AllRed"..v)
DevSOFI:del(athalos.."SOFI:Text:AllRed"..v)
DevSOFI:del(athalos.."SOFI:Sudo:AllRed")
end
...
DevSOFI:set(athalos..'SOFI:NameBot'..msg.sender_user_id_, 'msg')
return false 
end
end
...
DevSOFI:del(athalos..'SOFI:NameBot')
local athalosTeam = '✧ : اهلا عزيزي ↫ '..SOFIRank(msg)..' \n✧ : تم حذف اسم البوت'
SOFImoned(msg.chat_id_, msg.sender_user_id_, msg.id_, athalosTeam, 14, string.len(msg.sender_user_id_))
end end 
--     Source athalos     --
...
DevSOFI:set(athalos..'SOFI:Help0'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local athalosTeam =  DevSOFI:get(athalos..'SOFI:Help0'..msg.sender_user_id_)
if athalosTeam == 'msg' then
Dev_SOFI(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevSOFI:del(athalos..'SOFI:Help0'..msg.sender_user_id_)
DevSOFI:set(athalos..'SOFI:Help', text)
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevSOFI:set(athalos..'SOFI:Help01'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local athalosTeam =  DevSOFI:get(athalos..'SOFI:Help01'..msg.sender_user_id_)
if athalosTeam == 'msg' then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevSOFI:del(athalos..'SOFI:Help01'..msg.sender_user_id_)
DevSOFI:set(athalos..'SOFI:Help1', text)
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevSOFI:set(athalos..'SOFI:Help21'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local athalosTeam =  DevSOFI:get(athalos..'SOFI:Help21'..msg.sender_user_id_)
if athalosTeam == 'msg' then
Dev_SOFI(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevSOFI:del(athalos..'SOFI:Help21'..msg.sender_user_id_)
DevSOFI:set(athalos..'SOFI:Help2', text)
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevSOFI:set(athalos..'SOFI:Help31'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local athalosTeam =  DevSOFI:get(athalos..'SOFI:Help31'..msg.sender_user_id_)
if athalosTeam == 'msg' then
Dev_SOFI(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevSOFI:del(athalos..'SOFI:Help31'..msg.sender_user_id_)
DevSOFI:set(athalos..'SOFI:Help3', text)
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevSOFI:set(athalos..'SOFI:Help41'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local athalosTeam =  DevSOFI:get(athalos..'SOFI:Help41'..msg.sender_user_id_)
if athalosTeam == 'msg' then
Dev_SOFI(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevSOFI:del(athalos..'SOFI:Help41'..msg.sender_user_id_)
DevSOFI:set(athalos..'SOFI:Help4', text)
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
DevSOFI:set(athalos..'SOFI:Help51'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local athalosTeam =  DevSOFI:get(athalos..'SOFI:Help51'..msg.sender_user_id_)
if athalosTeam == 'msg' then
Dev_SOFI(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevSOFI:del(athalos..'SOFI:Help51'..msg.sender_user_id_)
DevSOFI:set(athalos..'SOFI:Help5', text)
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevSOFI:set(athalos..'SOFI:Help61'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local athalosTeam =  DevSOFI:get(athalos..'SOFI:Help61'..msg.sender_user_id_)
if athalosTeam == 'msg' then
Dev_SOFI(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevSOFI:del(athalos..'SOFI:Help61'..msg.sender_user_id_)
DevSOFI:set(athalos..'SOFI:Help6', text)
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
local Users = DevSOFI:smembers(athalos.."User_Bot")
local Groups = DevSOFI:smembers(athalos..'Chek:Groups')
local Sudos = DevSOFI:smembers(athalos.."Sudo:User")
if DevSOFI:get(athalos..'Name:Bot') then
DevSOFI:set(athalos..'SOFI:NameBot',(DevSOFI:get(athalos..'Name:Bot') or 'اثالوس'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
DevSOFI:sadd(athalos..'SOFI:Users',Users[i]) 
end
end
for i = 1, #Sudos do
DevSOFI:sadd(athalos..'SOFI:SudoBot:',Sudos[i]) 
end
for i = 1, #Groups do
DevSOFI:sadd(athalos..'SOFI:Groups',Groups[i]) 
if DevSOFI:get(athalos.."Private:Group:Link"..Groups[i]) then
DevSOFI:set(athalos.."SOFI:Groups:Links"..Groups[i],DevSOFI:get(athalos.."Private:Group:Link"..Groups[i]))
end
if DevSOFI:get(athalos.."Get:Welcome:Group"..Groups[i]) then
DevSOFI:set(athalos..'SOFI:Groups:Welcomes'..Groups[i],DevSOFI:get(athalos.."Get:Welcome:Group"..Groups[i]))
end
local list2 = DevSOFI:smembers(athalos..'Constructor'..Groups[i])
for k,v in pairs(list2) do
DevSOFI:sadd(athalos.."SOFI:Constructor:"..Groups[i], v)
end
local list3 = DevSOFI:smembers(athalos..'BasicConstructor'..Groups[i])
for k,v in pairs(list3) do
DevSOFI:sadd(athalos.."SOFI:BasicConstructor:"..Groups[i], v)
end
local list4 = DevSOFI:smembers(athalos..'Manager'..Groups[i])
for k,v in pairs(list4) do
DevSOFI:sadd(athalos.."SOFI:Managers:"..Groups[i], v)
end
local list5 = DevSOFI:smembers(athalos..'Mod:User'..Groups[i])
for k,v in pairs(list5) do
DevSOFI:sadd(athalos.."SOFI:Admins:"..Groups[i], v)
end
local list6 = DevSOFI:smembers(athalos..'Special:User'..Groups[i])
for k,v in pairs(list6) do
DevSOFI:sadd(athalos.."SOFI:VipMem:"..Groups[i], v)
end
DevSOFI:set(athalos.."SOFI:Lock:Bots"..Groups[i],"del") DevSOFI:hset(athalos.."SOFI:Spam:Group:User"..Groups[i] ,"Spam:User","keed") 
...
for i,Lock in pairs(LockList) do
DevSOFI:set(athalos..Lock..Groups[i],true)
end
end
...
DevSOFI:del(athalos..'SOFI:Text:BotWelcome')
DevSOFI:del(athalos..'SOFI:Photo:BotWelcome')
return false
end 
...
DevSOFI:del(athalos..'SOFI:Lock:BotWelcome')
return false
end 
...
DevSOFI:set(athalos..'SOFI:Lock:BotWelcome',true)
return false
end 
...
DevSOFI:del(athalos..'SOFI:Text:BotWelcome')
DevSOFI:del(athalos..'SOFI:Photo:BotWelcome')
DevSOFI:set(athalos.."SOFI:Set:BotWelcome"..msg.sender_user_id_,"Text") 
return false
end 
if text and DevSOFI:get(athalos.."SOFI:Set:BotWelcome"..msg.sender_user_id_) == 'Text' then 
if text and text:match("^الغاء$") then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم الغاء الامر", 1, "md") 
DevSOFI:del(athalos.."SOFI:Set:BotWelcome"..msg.sender_user_id_)   
return false
end 
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم حفظ النص ارسل لي صورة الترحيب\n✧ : ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
DevSOFI:set(athalos.."SOFI:Text:BotWelcome",text) 
DevSOFI:set(athalos.."SOFI:Set:BotWelcome"..msg.sender_user_id_,"Photo") 
return false 
end 
if DevSOFI:get(athalos.."SOFI:Set:BotWelcome"..msg.sender_user_id_) == 'Photo' then 
if text and text:match("^الغاء$") then 
...
DevSOFI:set(athalos.."SOFI:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
...
DevSOFI:setex(athalos.."SOFI:DevText"..msg.chat_id_..":" .. msg.sender_user_id_, 300, true)
end end
...
DevSOFI:del(athalos.."DevText")
end end
--     Source athalos     --
if DevSOFI:get(athalos.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, "✧ : تم الغاء الامر", 1, "md") 
DevSOFI:del(athalos.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevSOFI:del(athalos.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local texxt = string.match(text, "(.*)") 
DevSOFI:set(athalos..'SOFI:ChText',texxt)
...
DevSOFI:setex(athalos.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)   
...
DevSOFI:del(athalos..'SOFI:ChText')
...
Text = [[
✧ : [قناة السورس](https://t.me/Tl_300)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✧ قناة السورس',url="t.me/Tl_300"}},
}
local msg_id = msg.id_/2097152/0.5
...
DevSOFI:incr(athalos..'SOFI:EditMsg'..result.chat_id_..result.sender_user_id_)
local text = result.content_.text_ or result.content_.caption_
local Text = result.content_.text_
if DevSOFI:get(athalos..'SOFI:Lock:EditMsgs'..msg.chat_id_) and not Text and not SOFIConstructor(result) then
...
local GetMsgPin = DevSOFI:get(athalos..'SOFI:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;DevSOFI:del(athalos..'SOFI:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) DevSOFI:del(athalos..'SOFI:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
tdcli_function({ID = "ChangeChatMemberStatus",chat_id_=v,user_id_=athalos,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
DevSOFI:srem(athalos..'SOFI:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
DevSOFI:srem(athalos..'SOFI:Groups',v)  
end
...
DevSOFI:sadd(athalos..'SOFI:Groups',v)  
end end,nil) end
end
--     Source athalos     --
end 
